...
$query = "SELECT $t_exercise_types.type_id, $t_exercise_types.type_title, $t_exercise_types.type_image_path, $t_exercise_types.type_image_file, $t_exercise_types_translations.type_translation_id, $t_exercise_types_translations.type_translation_value FROM $t_exercise_types";
$query = $query . " JOIN $t_exercise_types_translations ON $t_exercise_types.type_id=$t_exercise_types_translations.type_id";
$query = $query . " WHERE $t_exercise_types_translations.type_translation_language=$l_mysql";
