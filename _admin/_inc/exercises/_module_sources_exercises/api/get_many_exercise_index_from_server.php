...
$x=0;
$q = "SELECT exercise_id, exercise_title, exercise_language FROM $t_exercise_index WHERE exercise_id BETWEEN $start_mysql AND $stop_mysql AND exercise_language=$l_mysql";
