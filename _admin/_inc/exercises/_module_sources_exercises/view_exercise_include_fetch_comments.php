...
/**
*
* File: exercises/view_exercise_include_fetch_comments.php
* Version 1.0.0
...
$count_comments = 0;
$query = "SELECT comment_id, comment_exercise_id, comment_text, comment_by_user_id, comment_by_user_name, comment_by_user_image_path, comment_by_user_image_file, comment_by_user_image_thumb_60, comment_by_user_ip, comment_created, comment_created_saying, comment_created_timestamp, comment_updated, comment_updated_saying, comment_likes, comment_dislikes, comment_read_blog_owner, comment_reported FROM $t_exercise_index_comments WHERE comment_exercise_id=$get_current_exercise_id";
$result = mysqli_query($link, $query);
while($row = mysqli_fetch_row($result)) {
	list($get_comment_id, $get_comment_exercise_id, $get_comment_text, $get_comment_by_user_id, $get_comment_by_user_name, $get_comment_by_user_image_path, $get_comment_by_user_image_file, $get_comment_by_user_image_thumb_60, $get_comment_by_user_ip, $get_comment_created, $get_comment_created_saying, $get_comment_created_timestamp, $get_comment_updated, $get_comment_updated_saying, $get_comment_likes, $get_comment_dislikes, $get_comment_read_blog_owner, $get_comment_reported) = $row;
	  ...
	  <td style=\"vertical-align: top;\">
		...
		<!-- Like, dislike, report spam + owner actions -->
			...
			if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
				...
				echo"<a href=\"users/login.php?l=$l&amp;referer=../downloads/comment_report.php?comment_id=$get_comment_id\">$l_report</a>\n";
			}
			echo"
			</p>
