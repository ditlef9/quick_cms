...
/**
*
* File: exercise/new_exercise_step_7_muscles_that_are_beeing_trained.php
* Version 1.0.0
	...
	if($get_exercise_id == ""){
		...
		if($action == "add"){
			...
			if($get_current_muscle_id != ""){
				...
				$query = "SELECT exercise_muscle_id FROM $t_exercise_index_muscles WHERE exercise_muscle_exercise_id=$get_exercise_id AND exercise_muscle_muscle_id=$get_current_muscle_id AND exercise_muscle_type='main'";
				$result = mysqli_query($link, $query);
				$row = mysqli_fetch_row($result);
				...
				if($get_exercise_muscle_id == ""){
					...
					VALUES 
					(NULL, '$get_exercise_id', '$get_current_muscle_id', 'main')")
		...
		if($action == "remove"){
			...
			if($get_current_muscle_id != ""){
				...
				if($get_exercise_muscle_id != ""){
					// Delete
					$result = mysqli_query($link, "DELETE FROM $t_exercise_index_muscles WHERE exercise_muscle_exercise_id=$get_exercise_id AND exercise_muscle_muscle_id=$get_current_muscle_id AND exercise_muscle_type='main'");
		...
		<!-- Used muscles -->
			<div class=\"left\" style=\"margin-right: 30px;\">
				<p><b>$l_main_muscles</b><br />
				$l_click_on_a_muscle_to_remove_it
				</p>
				<table class=\"hor-zebra\">
				 <tbody>";

				$query = "SELECT exercise_muscle_id, exercise_muscle_muscle_id FROM $t_exercise_index_muscles WHERE exercise_muscle_exercise_id='$get_exercise_id' AND exercise_muscle_type='main'";
				$result = mysqli_query($link, $query);
					...
					echo"
					  <tr>
					   <td style=\"padding-left: 8px;\">
						<span>
						<a href=\"new_exercise_step_7_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_group_id=$main_group_id&amp;sub_group_id=$sub_group_id&amp;muscle_id=$get_exercise_muscle_muscle_id&amp;l=$l&amp;action=remove\">$get_muscle_translation_simple_name</a>
						</span>
					   </td>
					  </tr>
					";
		...
		<!-- Used muscles -->
			<div class=\"left\" style=\"\">
				...
				$l_click_on_a_muscle_to_add_it_to_main_muscles
				</p>
				...
				while($row = mysqli_fetch_row($result)) {
					...
					echo"	
					 <thead>
					  <tr>
					   <th scope=\"col\">
						<a href=\"new_exercise_step_7_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;l=$l&amp;main_group_id=$get_main_muscle_group_id&amp;l=$l\""; if($main_group_id == "$get_main_muscle_group_id"){ echo" style=\"font-weight: bold;\"";}echo">$get_main_muscle_group_translation_name</a>
					   </th>
					  </tr>
					 </thead>
					 <tbody>
					...
					if($main_group_id == "$get_main_muscle_group_id"){
						...
						while($row_sub = mysqli_fetch_row($result_sub)) {
							...
							echo"
							  <tr>
							   <td style=\"padding-left: 8px;\">
								<a href=\"new_exercise_step_7_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_group_id=$get_main_muscle_group_id&amp;sub_group_id=$get_sub_muscle_group_id&amp;l=$l\""; if($sub_group_id == "$get_sub_muscle_group_id"){ echo" style=\"font-weight: bold;\"";}echo">$get_sub_muscle_group_translation_name</a>
							   </td>
							  </tr>
							";
							...
							if($sub_group_id == "$get_sub_muscle_group_id"){
								...
								while($row_m = mysqli_fetch_row($result_m)) {
									...
									echo"
									<a href=\"new_exercise_step_7_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_group_id=$get_main_muscle_group_id&amp;sub_group_id=$get_sub_muscle_group_id&amp;muscle_id=$get_muscle_id&amp;l=$l&amp;action=add\">$get_muscle_translation_simple_name</a>
									";
								...
								while($row_p = mysqli_fetch_row($result_p)) {
									...
									while($row_m = mysqli_fetch_row($result_m)) {
										...
										echo"
										<a href=\"new_exercise_step_7_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_group_id=$get_main_muscle_group_id&amp;sub_group_id=$get_sub_muscle_group_id&amp;muscle_id=$get_muscle_id&amp;l=$l&amp;action=add\">";
		...
		<div class=\"clear\"></div>
		<p>
		<a href=\"new_exercise_step_8_assistant_muscles.php?exercise_id=$exercise_id&amp;l=$l\" class=\"btn\" />$l_continue</a>
		</p>
