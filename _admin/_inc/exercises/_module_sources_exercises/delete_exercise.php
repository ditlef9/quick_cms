...
/**
*
* File: exercise/delete_exercise.php
* Version 1.0.0
...
/*- Headers ---------------------------------------------------------------------------------- */
$website_title = "$l_delete_exercise - $l_exercises";
...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_exercise_id == ""){
		...
		if($process == 1){
			...
			$result = mysqli_query($link, "DELETE FROM $t_exercise_index WHERE exercise_id=$exercise_id_mysql");
			...
			$result = mysqli_query($link, "DELETE FROM $t_exercise_index_images WHERE exercise_image_exercise_id='$get_exercise_id'");

			// Video
			$result = mysqli_query($link, "DELETE FROM $t_exercise_index_videos WHERE exercise_video_exercise_id='$get_exercise_id'");

			
			
			$url = "my_exercises.php?main_muscle_group_id=$main_muscle_group_id&type_id=$type_id&l=$l";
			$url = $url . "&ft=success&fm=exercises_deleted";
			header("Location: $url");
			exit;
		}
		echo"
		<h1>$l_delete_exercise</h1>
		...
		<!-- Where am I? -->
			...
			&gt;
			<a href=\"$root/exercises/deleteexercise.php?exercise_id=$exercise_id&amp;main_muscle_group_id=$main_muscle_group_id&amp;type_id=$type_id&amp;l=$l\">$l_delete</a>
			</p>
		<!-- //Where am I? -->
		...
		<p>
		<a href=\"$root/exercises/delete_exercise.php?exercise_id=$exercise_id&amp;main_muscle_group_id=$main_muscle_group_id&amp;type_id=$type_id&amp;l=$l&amp;process=1\">$l_confirm</a>
		|
		<a href=\"$root/exercises/my_exercises.php?main_muscle_group_id=$main_muscle_group_id&amp;type_id=$type_id&amp;l=$l\">$l_cancel</a>
		</p>
