...
/**
*
* File: _admin/_inc/hash_db/entry_edit.php
* Version 1.0
...
if($action == ""){
	...
	if($get_current_entry_id == ""){
		...
		if($process == "1"){
			...
			// Update
			mysqli_query($link, "UPDATE $t_hash_db_entries SET
						entry_category_id=$get_current_category_id, 
						entry_category_title=$inp_category_title_mysql, 
						entry_file_path=$inp_file_path_mysql, 
						entry_file_name=$inp_file_name_mysql, 
						entry_file_extension=$inp_file_extension_mysql, 
						entry_file_mime=$inp_file_mime_mysql, 
						entry_file_size_bytes=$inp_file_size_bytes_mysql, 
						entry_file_size_human=$inp_file_size_human_mysql, 
						entry_file_created_datetime=$inp_file_created_datetime_mysql, 
						entry_file_created_saying=$inp_file_created_datetime_saying_mysql, 
						entry_file_last_changed_datetime=$inp_file_last_changed_datetime_mysql, 
						entry_file_last_changed_saying=$inp_file_last_changed_datetime_saying_mysql, 
						entry_file_name_md5=$inp_file_name_md5_mysql, 
						entry_file_name_sha1=$inp_file_name_sha1_mysql, 
						entry_file_content_md5=$inp_file_content_md5_mysql, 
						entry_file_content_sha1=$inp_file_content_sha1_mysql, 
						entry_updated_datetime='$datetime',
						entry_updated_saying='$datetime_saying',
						entry_updated_by_user_id=$get_my_user_id,
						entry_updated_by_user_name=$inp_my_user_name_mysql
						WHERE entry_id=$get_current_entry_id")
						or die(mysqli_error($link)); 

			$url = "index.php?open=$open&page=$page&entry_id=$get_current_entry_id&category_id=$get_current_category_id&order_by=$order_by&order_method=$order_method&l=$l&editor_language=$editor_language&ft=success&fm=entry_changes_saved";
			header("Location: $url");
			exit;
		}
		echo"
		<h1>Edit entry $get_current_entry_file_name</h1>
		...
		<!-- Edit entry form -->
			<form method=\"post\" action=\"index.php?open=hash_db&amp;page=$page&amp;entry_id=$get_current_entry_id&amp;order_by=$order_by&amp;order_method=$order_method&amp;editor_language=$editor_language&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
			...
			while($row = mysqli_fetch_row($result)) {
				...
				echo"				<option value=\"$get_category_id\""; if($get_category_id == "$get_current_entry_category_id"){ echo" selected=\"selected\""; } echo">$get_category_title</option>\n";
			}
			echo"
			</select>
			</p>
			...
			<p>File path:<br />
			<input type=\"text\" name=\"inp_file_path\" value=\"$get_current_entry_file_path\" size=\"25\" style=\"width: 99%;\" tabindex=\""; $tabindex=$tabindex+1; echo"$tabindex\" />
			</p>

			<p>File name:<br />
			<input type=\"text\" name=\"inp_file_name\" value=\"$get_current_entry_file_name\" size=\"25\" style=\"width: 99%;\" tabindex=\""; $tabindex=$tabindex+1; echo"$tabindex\" />
			</p>

			<p>File extension:<br />
			<input type=\"text\" name=\"inp_file_extension\" value=\"$get_current_entry_file_extension\" size=\"25\" style=\"width: 99%;\" tabindex=\""; $tabindex=$tabindex+1; echo"$tabindex\" />
			</p>

			<p>File mime:<br />
			<input type=\"text\" name=\"inp_file_mime\" value=\"$get_current_entry_file_mime\" size=\"25\" style=\"width: 99%;\" tabindex=\""; $tabindex=$tabindex+1; echo"$tabindex\" />
			</p>

			<p>File size in bytes ($get_current_entry_file_size_human):<br />
			<input type=\"text\" name=\"inp_file_size_bytes\" value=\"$get_current_entry_file_size_bytes\" size=\"25\" style=\"width: 99%;\" tabindex=\""; $tabindex=$tabindex+1; echo"$tabindex\" />
			</p>

			<p>File created (YYYY-mm-dd HH:ii:ss) ($get_current_entry_file_created_saying):<br />
			<input type=\"text\" name=\"inp_file_created_datetime\" value=\"$get_current_entry_file_created_datetime\" size=\"25\" style=\"width: 99%;\" tabindex=\""; $tabindex=$tabindex+1; echo"$tabindex\" />
			</p>

			<p>File last changed (YYYY-mm-dd HH:ii:ss) ($get_current_entry_file_last_changed_saying):<br />
			<input type=\"text\" name=\"inp_file_last_changed_datetime\" value=\"$get_current_entry_file_last_changed_datetime\" size=\"25\" style=\"width: 99%;\" tabindex=\""; $tabindex=$tabindex+1; echo"$tabindex\" />
			</p>

			<p>File content md5:<br />
			<input type=\"text\" name=\"inp_file_content_md5\" value=\"$get_current_entry_file_content_md5\" size=\"25\" style=\"width: 99%;\" tabindex=\""; $tabindex=$tabindex+1; echo"$tabindex\" />
			</p>

			<p>File content sha1:<br />
			<input type=\"text\" name=\"inp_file_content_sha1\" value=\"$get_current_entry_file_content_sha1\" size=\"25\" style=\"width: 99%;\" tabindex=\""; $tabindex=$tabindex+1; echo"$tabindex\" />
			</p>
