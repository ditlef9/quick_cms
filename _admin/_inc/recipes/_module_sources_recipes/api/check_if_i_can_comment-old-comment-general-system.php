...
// Check by user ID
$query = "SELECT block_id FROM $t_comments_users_block WHERE block_user_id=$inp_user_id_mysql AND block_object='recipe' AND block_object_id=$inp_recipe_id_mysql AND block_to=$block_to";
...
if($get_block_id != ""){
	...
	// Check by user IP
	$query = "SELECT block_id FROM $t_comments_users_block WHERE block_user_ip=$my_user_ip_mysql AND block_object='recipe' AND block_object_id=$inp_recipe_id_mysql AND block_to=$block_to";
	$result = mysqli_query($link, $query);
	$row = mysqli_fetch_row($result);
	list($get_block_id) = $row;
	if($get_block_id != ""){
