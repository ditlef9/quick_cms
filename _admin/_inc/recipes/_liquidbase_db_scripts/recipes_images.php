...
/**
*
* File: _admin/_inc/recipes/_liquibase/recipes_images.php
* Version 1.0.0
* Date 21:31 10.01.2021
...
/*- Tables ---------------------------------------------------------------------------- */
	...
	mysqli_query($link, "DROP TABLE IF EXISTS $t_recipes_images") or die(mysqli_error());
echo"

	<!-- recipes_images -->
	";
	$query = "SELECT * FROM $t_recipes_images";
	$result = mysqli_query($link, $query);
	if($result !== FALSE){
		// Count rows
		$row_cnt = mysqli_num_rows($result);
		echo"
		<p>$t_recipes_images: $row_cnt</p>
		";
	}
	else{
		mysqli_query($link, "CREATE TABLE $t_recipes_images(
