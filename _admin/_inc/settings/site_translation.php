						...
						<table>
						 <tr>
						  <td style=\"padding: 2px 6px 0px 0px;\" >
							<a href=\"index.php?open=$open&amp;page=$page&amp;mode=open_directory&amp;folder=$get_site_translation_directory_name&amp;language=$language&amp;editor_language=$editor_language\"><img src=\"_design/gfx/icons/18x18/"; if($folder == "$get_site_translation_directory_name"){ echo"folder_open_outline_black_18x18.png"; } else{ echo"folder_outline_black_18x18.png"; } echo"\" alt=\"folder_outline_black_18x18.png\" /></a>
						  </td>
						  <td>
				...
				if ($handle = opendir($dir)) {
					while (false !== ($content = readdir($handle))) {
						...
						if(isset($next_file)){
							...
							<a href=\"index.php?open=settings&amp;page=site_translation&amp;mode=edit_language_file&amp;language=$language&amp;folder=$folder&amp;file=$content_saying&amp;l=$l\"><img src=\"_design/gfx/icons/18x18/navigate_next_outline_black_18x18.png\" alt=\"navigate_next_outline_black_18x18.png\" /></a>
							</p>
							";
							break;
						}
...
elseif($mode == "flag"){
		...
		if(is_dir("_translations/site/$language") && $language != ""){
			...
			<!-- Go back -->
				<p>
				<a href=\"index.php?open=settings&amp;page=site_translation&amp;mode=open_language&amp;language=$language&amp;l=$l\"><img src=\"_design/gfx/icons/18x18/navigate_before_outline_black_18x18.png\" alt=\"navigate_before_outline_black_18x18.png\" /></a>
				...
				<div class=\"content_right_box\">
					...
					while($row = mysqli_fetch_row($result)) {
						...
						<table>
						 <tr>
						  <td style=\"padding: 2px 6px 0px 0px;\" >
							<a href=\"index.php?open=$open&amp;page=$page&amp;mode=open_directory&amp;folder=$get_site_translation_directory_name&amp;language=$language&amp;editor_language=$editor_language\"><img src=\"_design/gfx/icons/18x18/folder_outline_black_18x18.png\" alt=\"folder_outline_black_18x18.png\" /></a>
						  </td>
						  <td>
...
elseif($mode == "open_directory"){
	...
	<!-- Content Right -->
		...
		<!-- Go back -->
			<div class=\"clear\"></div>
			<p>
			<a href=\"index.php?open=settings&amp;page=site_translation\"><img src=\"_design/gfx/icons/18x18/navigate_before_outline_black_18x18.png\" alt=\"navigate_before_outline_black_18x18.png\" /></a>
