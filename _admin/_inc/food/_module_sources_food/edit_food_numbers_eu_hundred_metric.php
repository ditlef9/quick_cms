...
/**
*
* File: food/edit_food_numbers_eu_hundred_metric.php
* Version 1.0.0
* Date 13:23 08.04.2022
		...
		elseif($access == 1){
			if($process == 1){
				...
				if($ft == ""){	
					...
					$url = "edit_food_numbers_eu_hundred_metric.php?food_id=$get_current_food_id&l_$l&ft=success&fm=changes_saved";
					header("Location: $url");
					exit;
				}
				else{
					$url = "edit_food_numbers_eu_hundred_metric.php?food_id=$get_current_food_id&l=$l";
					$url = $url . "&ft=$ft&fm=$fm";
					header("Location: $url");
					exit;
				}
			...
			<!-- Where am I? -->
				...
				&gt;
				<a href=\"edit_food_numbers_eu_hundred_metric.php?food_id=$food_id&amp;l=$l\">$l_numbers</a>
				</p>
			<!-- //Where am I? -->
			...
			";
			if($get_current_food_serving_size_us == ""){
				echo"<div class=\"error\"><p>Missing food_serving_size_us</p></div>";
			}
			echo"
						...
						<div class=\"two_columns\">
							...
							<!-- System-country + Measurement -->
								<div style=\"text-align: center;\">
									<span>
									<a href=\"edit_food_numbers_eu_hundred_metric.php?food_id=$food_id&amp;l=$l\" style=\"font-weight:bold;\"><img src=\"_gfx/flags/european_union_16x16.png\" alt=\"european_union_16x16.png\" /> EU</a>
									&nbsp;
									<a href=\"edit_food_numbers_us_pcs.php?food_id=$food_id&amp;l=$l\"><img src=\"_gfx/flags/united_states_50_percent_16x16.png\" alt=\"united_states_16x16.png\" /> USA</a>
									<br />
						
									<a href=\"edit_food_numbers_eu_hundred_metric.php?food_id=$food_id&amp;l=$l\" style=\"font-weight:bold;\">$l_per_hundred</a>
									&middot;
									<a href=\"edit_food_numbers_eu_pcs_metric.php?food_id=$food_id&amp;l=$l\">$get_current_food_serving_size_pcs $get_current_food_serving_size_pcs_measurement</a>
									</span>
								</div>
							<!-- //System-country + Measurement -->
							...
							<form method=\"post\" action=\"edit_food_numbers_eu_hundred_metric.php?food_id=$get_current_food_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\" id=\"edit_food_numbers_form\">
							...
							<table class=\"hor-zebra\" style=\"width: 350px\">
							 ...
							 <tbody>
							  ...
							  <tr>
							   ...
							   <td style=\"text-align: center;padding: 0px 4px 0px 4px;\">
								...
								<span class=\"food_trans_fat_calculated\">$get_current_food_trans_fat_calculated_metric</span><br />
							 ...
							 <tr>
					 		  ...
					 		  <td style=\"text-align: center;padding: 0px 4px 0px 4px;\">
								...
								<span class=\"food_carbohydrates_of_which_sugars_calculated\">$get_current_food_carbohydrates_of_which_sugars_calculated_metric</span><br />
								<span class=\"food_added_sugars_calculated\">$get_current_food_added_sugars_calculated_metric</span>
								</p>
