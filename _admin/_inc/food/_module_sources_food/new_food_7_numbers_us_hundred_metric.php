...
/**
*
* File: food/new_food_7_numbers_us_hundred_metric.php
* Version 1.0.0
* Date 12:04 12.04.2022
	...
	if($get_current_food_id == ""){
		...
		if($process == "1"){
				...
				if($ft == ""){	
					...
					// Header
					$url = "new_food_8_tags.php?main_category_id=$get_current_food_main_category_id&sub_category_id=$get_current_food_sub_category_id&food_id=$get_current_food_id&l=$l";
					header("Location: $url");
					exit;
				}
				else{
					$url = "new_food_7_numbers_us_hundred_metric.php?main_category_id=$get_current_food_main_category_id&sub_category_id=$get_current_food_sub_category_id&food_id=$get_current_food_id&l=$l";
					$url = $url . "&ft=$ft&fm=$fm";
					header("Location: $url");
					exit;
				}
						...
						<div class=\"two_columns\">
							...
							<!-- System-country + Measurement -->
								<div style=\"text-align: center;\">
									<span>
									<a href=\"new_food_7_numbers_eu_hundred_metric.php?food_id=$food_id&amp;l=$l\"><img src=\"_gfx/flags/european_union_50_percent_16x16.png\" alt=\"european_union_16x16.png\" /> EU</a>
									&nbsp;
									...
									<br />
									<a href=\"new_food_7_numbers_us_hundred_metric.php?food_id=$food_id&amp;l=$l\" style=\"font-weight:bold;\">$l_per_100</a>
									&middot;
									<a href=\"new_food_7_numbers_us_pcs.php?food_id=$food_id&amp;l=$l\">$get_current_food_serving_size_pcs $get_current_food_serving_size_pcs_measurement</a>
									</span>
								</div>
							<!-- //System-country + Measurement -->


							<form method=\"post\" action=\"new_food_7_numbers_us_hundred_metric.php?main_category_id=$get_current_food_main_category_id&amp;sub_category_id=$get_current_food_sub_category_id&amp;food_id=$get_current_food_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
							...
							<table class=\"hor-zebra\" style=\"width: 350px\">
							 ...
							 <tbody>
							  ...
							  <tr>
								...
								<p style=\"margin:0;padding: 0;\">$l_dash_total_sugars</p>
