...
/**
*
* File: food/new_food_7_numbers_us_pcs.php
* Version 1.0.0
				...
				<div class=\"two_rows\">
					...
					<!-- Numbers -->
						<div class=\"two_columns\">
							...
							<form method=\"post\" action=\"new_food_7_numbers_us_pcs.php?main_category_id=$get_current_food_main_category_id&amp;sub_category_id=$get_current_food_sub_category_id&amp;food_id=$get_current_food_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
							 ...
							 <tbody>
							  ...
							  <tr>
					 		  ...
					 		  <td style=\"text-align: center;padding: 0px 4px 0px 4px;\">
								...
								<!-- On change dietary proteins calculate -->
								<script>
								\$(document).ready(function(){
