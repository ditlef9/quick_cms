...
/**
*
* File: blog/my_blog_edit_post_meta.php
* Version 1.0.0
	...
	if($get_current_blog_info_id == ""){
		...
		if($get_current_blog_post_id == ""){
			...
			<!-- Where am I ? -->
				...
				&gt;
				<a href=\"my_blog_edit_post_meta.php?post_id=$get_current_blog_post_id&amp;l=$l\">$l_meta</a>
				</p>
			<!-- //Where am I ? -->
			...
			<!-- Edit meta -->
				...
				<form method=\"post\" action=\"my_blog_edit_post_meta.php?post_id=$get_current_blog_post_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
				<!-- Form Buttons -->
						<p>
