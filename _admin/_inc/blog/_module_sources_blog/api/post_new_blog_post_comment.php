...
if(isset($_POST['inp_post_id'])) {
	...
	$post_id_mysql = quote_smart($link, $inp_post_id);
	$query = "SELECT blog_post_id, blog_post_user_id, blog_post_title, blog_post_language, blog_post_category_id,  blog_post_privacy_level, blog_post_introduction, blog_post_text, blog_post_image_path, blog_post_image_file, blog_post_ad, blog_post_created, blog_post_updated, blog_post_comments, blog_post_views, blog_post_views_ipblock FROM $t_blog_posts WHERE blog_post_id=$post_id_mysql";
	$result = mysqli_query($link, $query);
	$row = mysqli_fetch_row($result);
	list($get_current_blog_post_id, $get_current_blog_post_user_id, $get_current_blog_post_title, $get_current_blog_post_language, $get_current_blog_post_category_id, $get_current_blog_post_privacy_level, $get_current_blog_post_introduction, $get_current_blog_post_text, $get_current_blog_post_image_path, $get_current_blog_post_image_file, $get_current_blog_post_ad, $get_current_blog_post_created, $get_current_blog_post_updated, $get_current_blog_post_comments, $get_current_blog_post_views, $get_current_blog_post_views_ipblock) = $row;
...
/*- Object -------------------------------------------------------------------------------- */
$object_mysql = quote_smart($link, "blog_post");
$object_id_mysql = quote_smart($link, $get_current_blog_post_id);
...
$view_link = $configSiteURLSav . "/blog/view_post.php?post_id=$get_current_blog_post_id#comments";
...
// Email	
$subject = "New Blog API comment from $get_my_user_alias at $host ($inp_comment_created)";
