...
/*- Get blog post ------------------------------------------------------------------------- */
// Get ID
$query = "SELECT blog_post_id, blog_post_user_id, blog_post_category_id FROM $t_blog_posts WHERE blog_post_language=$l_mysql AND blog_post_privacy_level='everyone' ORDER BY blog_post_id DESC LIMIT 0,1";
$result = mysqli_query($link, $query);
$row = mysqli_fetch_row($result);
list($get_current_blog_post_id, $get_current_blog_post_user_id, $get_current_blog_post_category_id) = $row;
...
// Json everything
$rows_json = json_encode(utf8ize($return_array));
