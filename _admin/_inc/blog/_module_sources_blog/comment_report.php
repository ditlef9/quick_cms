...
/**
*
* File: blog/comment_mark_as_spam.php
* Version 1.0.0
...
$query = "SELECT comment_id, comment_blog_post_id, comment_blog_info_id, comment_text, comment_by_user_id, comment_by_user_name, comment_by_user_image_path, comment_by_user_image_file, comment_by_user_image_thumb_60, comment_by_user_ip, comment_created, comment_created_saying, comment_created_timestamp, comment_updated, comment_updated_saying, comment_likes, comment_dislikes, comment_read_blog_owner, comment_reported, comment_reported_by_user_id, comment_reported_reason, comment_reported_checked FROM $t_blog_posts_comments WHERE comment_id=$comment_id_mysql";
	...
	if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
		...
		if($get_current_comment_reported == "1"){
			...
			if($inp_text == ""){
				...
				// Update
				mysqli_query($link, "UPDATE $t_blog_posts_comments SET
							comment_reported=1,
				...
				// Refresh site
				$url = "view_post.php?post_id=$get_current_blog_post_id&l=$l&ft_comment=success&fm_comment=comment_reported#comment$get_current_comment_id";
				header("Location: $url");
				exit;
			} // text 
