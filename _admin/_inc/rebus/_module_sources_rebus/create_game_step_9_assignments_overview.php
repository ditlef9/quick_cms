...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
		...
		<!-- Assignments -->
			...
			while($row = mysqli_fetch_row($result)) {
				...
				echo"
				 <tr>
				  <td>
					<span><a href=\"create_game_step_9_assignments_overview.php?action=edit_assignment&amp;game_id=$get_current_game_id&amp;assignment_id=$get_assignment_id&amp;l=$l\">$get_assignment_number</a></span>
				  </td>
				  <td>
					<span><a href=\"create_game_step_9_assignments_overview.php?action=edit_assignment&amp;game_id=$get_current_game_id&amp;assignment_id=$get_assignment_id&amp;l=$l\">$get_assignment_value_short</a></span>
				  ...
				  <td>
					<span>
					<a href=\"create_game_step_9_assignments_overview.php?action=move_assignment_up&amp;game_id=$get_current_game_id&amp;assignment_id=$get_assignment_id&amp;l=$l&amp;process=1\"><img src=\"_gfx/keyboard_arrow_up_black_18x18.png\" alt=\"keyboard_arrow_up_black_18x18.png\" /></a>
					<a href=\"create_game_step_9_assignments_overview.php?action=move_assignment_down&amp;game_id=$get_current_game_id&amp;assignment_id=$get_assignment_id&amp;l=$l&amp;process=1\"><img src=\"_gfx/keyboard_arrow_down_black_18x18.png\" alt=\"keyboard_arrow_down_black_18x18.png\" /></a>
					</span>
				  </td>
				 </tr>
				";
	...
	elseif($action == "delete_assignment"){
		...
		$query = "SELECT assignment_id, assignment_game_id, assignment_number, assignment_type, assignment_value FROM $t_rebus_games_assignments WHERE assignment_id=$assignment_id_mysql AND assignment_game_id=$get_current_game_id";
		$result = mysqli_query($link, $query);
		$row = mysqli_fetch_row($result);
		list($get_current_assignment_id, $get_current_assignment_game_id, $get_current_assignment_number, $get_current_assignment_type, $get_current_assignment_value) = $row;
	...
	elseif($action == "move_assignment_up"){
		...
		if($get_switched_assignment_id == ""){
			// No can do
			$url = "create_game_step_9_assignments_overview.php?game_id=$get_current_game_id&l=$l&ft=success&fm=could_not_find_assignment_to_switch_with";
			header("Location: $url");
			exit;
		}
		...
		$url = "create_game_step_9_assignments_overview.php?game_id=$get_current_game_id&l=$l";
		header("Location: $url");
		exit;
	} // move assignment up
