...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($action == ""){
		...
		<!-- Where am I ? -->
			...
			&gt;
			<a href=\"my_games_edit_image.php?game_id=$get_current_game_id&amp;l=$l\">$l_image</a>
			</p>
		<!-- //Where am I ? -->
		...
		<!-- Add image form -->
			...
			<p><a href=\"create_game_step_8_add_assignment.php?game_id=$get_current_game_id&amp;l=$l\" class=\"btn_default\">$l_skip</a></p>
