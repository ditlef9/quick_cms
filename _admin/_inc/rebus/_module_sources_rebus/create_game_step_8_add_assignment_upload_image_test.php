...
/**
*
* File: rebus/create_game_step_8_add_assignment_upload_image_test.php
* Version 1.0.0.
	...
	echo"
			Test
				...
				<!-- Upload form -->
					...
					<form method=\"POST\" action=\"create_game_step_8_add_assignment_upload_image.php?game_id=$get_current_game_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
					<p>
