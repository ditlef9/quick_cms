...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($process == "1"){
		...
		// Delete group
		mysqli_query($link, "DELETE FROM $t_rebus_groups_index WHERE group_id=$get_current_group_id") or die(mysqli_error($link));
		...
		// Delete members
		mysqli_query($link, "DELETE FROM $t_rebus_groups_members WHERE member_group_id=$get_current_group_id") or die(mysqli_error($link));


		$url = "groups.php?ft=success&fm=deleted&l=$l";
		header("Location: $url");
		exit;
	} // process
	...
	<!-- Where am I ? -->
		...
		&gt;
		<a href=\"group_delete.php?group_id=$get_current_group_id&amp;l=$l\">$l_delete_group</a>
		</p>
	<!-- //Where am I ? -->
	...
	<!-- Delete group form-->
		...
		<p>
		<a href=\"group_delete.php?group_id=$get_current_group_id&amp;l=$l&amp;process=1\" class=\"btn_danger\">$l_confirm</a>
		</p>
	<!-- //Delete group form -->
	";
}
