...
/**
*
* File: _admin/_inc/rebus/_liquibase/rebus/groups_members.php
* Version 1.0.0
...
$result = mysqli_query($link, "DROP TABLE IF EXISTS $t_rebus_groups_members") or die(mysqli_error($link)); 
...
$query = "SELECT * FROM $t_rebus_groups_members LIMIT 1";
$result = mysqli_query($link, $query);
if($result !== FALSE){
	// Count rows
	$row_cnt = mysqli_num_rows($result);
	echo"
	<p>$t_rebus_groups_members: $row_cnt</p>
	";
}
else{


	mysqli_query($link, "CREATE TABLE $t_rebus_groups_members(
