...
$result = mysqli_query($link, "UPDATE $t_users SET user_measurement=$inp_user_measurement_mysql, user_last_online=$inp_user_last_online_mysql, user_last_ip=$inp_user_last_ip_mysql, user_synchronized=$inp_user_synchronized_mysql WHERE user_id=$get_user_id");

echo"Measurement updated to $inp_user_measurement ok";
