...
if(isset($_POST['inp_goal_current_weight'])){
	$inp_goal_current_weight = $_POST['inp_goal_current_weight'];
	$inp_goal_current_weight = output_html($inp_goal_current_weight);
	$inp_goal_current_weight_mysql = quote_smart($link, $inp_goal_current_weight);
}
else{
	echo"Missing inp_goal_current_weight";
	die;
}
if(isset($_POST['inp_goal_current_fat_percentage'])){
	$inp_goal_current_fat_percentage = $_POST['inp_goal_current_fat_percentage'];
	$inp_goal_current_fat_percentage = output_html($inp_goal_current_fat_percentage);
	$inp_goal_current_fat_percentage_mysql = quote_smart($link, $inp_goal_current_fat_percentage);
}
else{
	echo"Missing inp_goal_current_fat_percentage";
	die;
}
...
if(isset($_POST['inp_goal_target_weight'])){
	...
	echo"Missing inp_goal_target_weight";
	die;
}
if(isset($_POST['inp_goal_target_fat_percentage'])){
	$inp_goal_target_fat_percentage = $_POST['inp_goal_target_fat_percentage'];
	$inp_goal_target_fat_percentage = output_html($inp_goal_target_fat_percentage);
	$inp_goal_target_fat_percentage_mysql = quote_smart($link, $inp_goal_target_fat_percentage);
}
else{
	echo"Missing inp_goal_target_fat_percentage";
	die;
}
...
if(isset($_POST['inp_goal_i_want_to'])){
	...
	echo"Missing inp_goal_i_want_to";
	die;
}
if(isset($_POST['inp_goal_weekly_goal'])){
	...
	echo"Missing inp_goal_weekly_goal";
	die;
}
if(isset($_POST['inp_goal_date'])){
	$inp_goal_date = $_POST['inp_goal_date'];
	$inp_goal_date = output_html($inp_goal_date);
	$inp_goal_date_mysql = quote_smart($link, $inp_goal_date);
}
else{
	echo"Missing inp_goal_date";
	die;
}
...
if(isset($_POST['inp_goal_current_bmi'])){
	$inp_goal_current_bmi = $_POST['inp_goal_current_bmi'];
	$inp_goal_current_bmi = output_html($inp_goal_current_bmi);
	$inp_goal_current_bmi_mysql = quote_smart($link, $inp_goal_current_bmi);
}
else{
	echo"Missing inp_goal_current_bmi";
	die;
}
if(isset($_POST['inp_goal_target_bmi'])){
	...
	echo"Missing inp_goal_target_bmi";
	die;
}
...
goal_current_weight=$inp_goal_current_weight_mysql,
goal_current_fat_percentage=$inp_goal_current_fat_percentage_mysql,
goal_target_weight=$inp_goal_target_weight_mysql,
goal_target_fat_percentage=$inp_goal_target_fat_percentage_mysql,
goal_i_want_to=$inp_goal_i_want_to_mysql,
goal_weekly_goal=$inp_goal_weekly_goal_mysql,
goal_date=$inp_goal_date_mysql,
goal_activity_level=$inp_goal_activity_level_mysql,
goal_current_bmi=$inp_goal_current_bmi_mysql,
goal_target_bmi=$inp_goal_target_bmi_mysql
