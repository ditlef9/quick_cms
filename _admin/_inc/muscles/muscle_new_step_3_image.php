...
/**
*
* File: _admin/_inc/muscles/muscle_new_step_3_image.php
...
if($get_current_muscle_id == ""){
	...
	if($process == 1){
		...
		// Header
		$url = "index.php?open=$open&page=view_muscle&main_muscle_group_id=$get_current_main_muscle_group_id&sub_muscle_group_id=$get_current_sub_muscle_group_id&muscle_id=$muscle_id&editor_language=$editor_language";
		if(isset($ft_image)){
