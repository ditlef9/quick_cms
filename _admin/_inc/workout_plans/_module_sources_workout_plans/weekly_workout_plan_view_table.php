...
/**
*
* File: workout_plans/weekly_workout_plan_view_table.php
* Version 1.0.0
...
include("$root/_admin/_translations/site/$l/workout_plans/ts_weekly_workout_plan_view_print.php");
...
<head>
	...
	<title>$get_current_workout_weekly_title (Table version)</title>
	<style type=\"text/css\">
	body{
	...
	/*- Tables ------------------------------------------------------------------ */
		...
		td.headcell {
			background: #e2e2e2;
			box-shadow: inset 0 0 0 1000px #e2e2e2;
			padding: 4px;
	...
	<!-- Sessions -->
		...
		while($row = mysqli_fetch_row($result)) {
			...
			<table class=\"exercises\">
			  <tr>
			   <td class=\"headcell\" colspan=\"2\" style=\"border-right: #d4d4d4 1px solid;\">
				<span><b>$get_workout_session_title</b></span>
			   </td>
			   <td class=\"headcell\" style=\"text-align: center;border-right: #d4d4d4 1px solid;width: 8%;\">
				<span><b>$weekOne</b></span>
			   </td>
			   <td class=\"headcell\" style=\"text-align: center;border-right: #d4d4d4 1px solid;width: 8%;\">
				<span><b>$weekTwo</b></span>
			   </td>
			   <td class=\"headcell\" style=\"text-align: center;border-right: #d4d4d4 1px solid;width: 8%;\">
				<span><b>$weekThree</b></span>
			   </td>
			   <td class=\"headcell\" style=\"text-align: center;border-right: #d4d4d4 1px solid;width: 8%;\">
				<span><b>$weekFour</b></span>
			   </td>
			   <td class=\"headcell\" style=\"text-align: center;width: 8%;\">
				<span><b>$weekFive</b></span>
			   </td>
			  </tr>
				...
				while($row_sessions = mysqli_fetch_row($result_sessions)) {
					...
					echo"
					 <tr>
					  <td class=\"$style\" style=\"padding-right: 4px;\">
						<span><a href=\"$root/exercises/view_exercise.php?exercise_id=$get_workout_session_main_exercise_id&amp;l=$l\" class=\"h2\">$human_counter $get_workout_session_main_exercise_title</a>";
					if($get_workout_session_main_text != ""){
						echo" ($get_workout_session_main_text)";
					}	
					echo"
						</span>
					  </td>
					  <td class=\"$style\" style=\"border-right: #d4d4d4 1px solid;text-align: right;\">
						<span>
					";
					$middot = false;
					...
					echo"
					   ...
					   <td class=\"$style\" style=\"border-right: #d4d4d4 1px solid;\">
