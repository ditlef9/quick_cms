...
if(isset($_GET['l'])) {
	...
	$query = "SELECT workout_weekly_id FROM $t_workout_plans_weekly ORDER BY workout_weekly_id DESC LIMIT 0,1";
	$result = mysqli_query($link, $query);
	$row = mysqli_fetch_row($result);
	list($get_workout_weekly_id) = $row;

	echo"$get_workout_weekly_id";
}
