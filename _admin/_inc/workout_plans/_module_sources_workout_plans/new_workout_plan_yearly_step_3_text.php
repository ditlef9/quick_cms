...
/**
*
* File: food/new_new_workout_plan_yearly_step_3_text.php
* Version 1.0.0
...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_workout_yearly_id == ""){
		...
		if($process == "1"){
			...
			$sql = "UPDATE $t_workout_plans_yearly SET workout_yearly_text=? WHERE workout_yearly_id=$yearly_id_mysql";
			...
			// Header
			$url = "new_workout_plan_yearly_step_4_image.php?yearly_id=$yearly_id&l=$l";
			header("Location: $url");
			exit;
		...
		<!-- Form -->
			...
			<form method=\"post\" action=\"new_workout_plan_yearly_step_3_text.php?yearly_id=$yearly_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
	


			<p><b>$l_text:</b><br />
			<textarea name=\"inp_text\" rows=\"10\" cols=\"70\" class=\"editor\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\">$get_current_workout_yearly_text</textarea>
			</p>
