...
/**
*
* File: _admin/_inc/workout_plans/workout_plans.php
* Version 1.0
...
if($action == ""){
	...
	<!-- Workout plans menu-->
		<p>
		<a href=\"index.php?open=$open&amp;page=$page&amp;action=sql_lite&amp;editor_language=$editor_language\" class=\"btn\">SQL Lite</a>
		</p>
	<!-- //Workout plans menu -->
	";
}
elseif($action == "sql_lite"){
...
";
		...
		while($row_t = mysqli_fetch_row($result_t)) {
			...
			$inp_workout_session_title_mysql = quote_smart($link, $get_workout_session_title);
			...
			$inp_workout_session_goal_mysql = quote_smart($link, $get_workout_session_goal);
			$inp_workout_session_warmup_mysql = quote_smart($link, $get_workout_session_warmup);
			$inp_workout_session_end_mysql = quote_smart($link, $get_workout_session_end);
