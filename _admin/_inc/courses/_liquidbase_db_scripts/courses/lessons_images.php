...
/**
*
* File: _admin/_inc/courses/_liquibase/courses/lessons_images.php
* Version 1.0.0
...
<p>Create table: $t_courses_lessons_images</p>
";


$mysqli->query("DROP TABLE IF EXISTS $t_courses_lessons_images");

if (!$mysqli -> query("CREATE TABLE $t_courses_lessons_images(
