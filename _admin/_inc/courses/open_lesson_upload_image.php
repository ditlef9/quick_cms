...
/**
*
* File: _admin/_inc/courses/open_lesson_upload_image.php
* Version 
	...
	if($get_current_module_id == ""){
		...
		if($get_current_lesson_id == ""){
			...
			if($process == "1"){
				...
				if(!(is_dir("../$get_current_course_title_clean/$get_current_module_title_clean/_images/$get_current_lesson_title_clean"))){
					mkdir("../$get_current_course_title_clean/$get_current_module_title_clean/_images/$get_current_lesson_title_clean");
				}

				// Upload image

				// Image folder
				$imageFolder = "../$get_current_course_title_clean/$get_current_module_title_clean/_images/$get_current_lesson_title_clean/";
				...
				if (is_uploaded_file($temp['tmp_name'])){
					...
					$inp_file_path = "$get_current_course_title_clean/$get_current_module_title_clean/_images/$get_current_lesson_title_clean";
					...
					mysqli_query($link, "INSERT INTO $t_courses_lessons_images
					(image_id, image_course_id, image_module_id, image_lesson_id, image_title, image_text, 
					...
					VALUES 
					(NULL, $get_current_course_id, $get_current_module_id, $get_current_lesson_id, $inp_title_mysql, '', 
