	...
	if($get_current_sub_category_id == ""){
		...
		if($get_current_main_category_id == ""){
			...
			<!-- Where am I? -->
				...
				&gt;
				<a href=\"index.php?open=courses&amp;page=open_sub_category&amp;sub_category_id=$get_current_sub_category_id&amp;editor_language=$editor_language&amp;l=$l\">$get_current_sub_category_title</a>
				</p>
			<!-- //Where am I? -->
						...
						while($row = mysqli_fetch_row($result)) {
							...
							if($get_main_category_id == "$get_current_main_category_id"){
								...
								while($row_sub = mysqli_fetch_row($result_sub)) {
									...
									echo"
									&nbsp; &nbsp; <a href=\"index.php?open=$open&amp;page=open_sub_category&amp;sub_category_id=$get_sub_category_id&amp;editor_language=$editor_language&amp;l=$l\""; if($get_sub_category_id == "$get_current_sub_category_id"){ echo" style=\"font-weight:bold;\""; } echo">$get_sub_category_title</a><br />
									";
