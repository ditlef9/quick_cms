...
/**
*
* File: _admin/_inc/comments/open_category.php
* Version 
...
if($action == ""){
	...
	if($get_current_category_id == ""){
		...
		<!-- Where am I? -->
			...
			&gt;
			<a href=\"index.php?open=courses&amp;page=$page&amp;category_id=$category_id&amp;editor_language=$editor_language&amp;l=$l\">$get_current_category_title</a>
			</p>
		<!-- //Where am I? -->

		<!-- Menu -->
			<p>
			<a href=\"index.php?open=courses&amp;page=new_course&amp;category_id=$category_id&amp;editor_language=$editor_language&amp;l=$l\" class=\"btn_default\">New course</a>
		...
		<!-- List all courses -->
			...
			while($row = mysqli_fetch_row($result)) {
				list($get_course_id, $get_course_title, $get_course_language, $get_course_dir_name, $get_course_category_id, $get_course_intro_video_embedded, $get_course_icon_48, $get_course_icon_64, $get_course_icon_96, $get_course_modules_count, $get_course_lessons_count, $get_course_quizzes_count, $get_course_users_enrolled_count, $get_course_read_times, $get_course_created, $get_course_updated) = $row;
				...
				<tr>
				  <td"; if($odd == true){ echo" class=\"odd\""; } echo">
					<a href=\"index.php?open=$open&amp;page=open_course&amp;course_id=$get_course_id&amp;editor_language=$editor_language&amp;l=$l\">$get_course_title</a>
				  </td>
				  <td"; if($odd == true){ echo" class=\"odd\""; } echo">
					<span>
					<a href=\"index.php?open=$open&amp;page=edit_course&amp;course_id=$get_course_id&amp;editor_language=$editor_language\">Edit</a>
					&middot;
					<a href=\"index.php?open=$open&amp;page=delete_course&amp;course_id=$get_course_id&amp;editor_language=$editor_language\">Delete</a>
					</span>
				 </td>
				</tr>
				";
