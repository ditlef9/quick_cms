...
/**
*
* File: _admin/_inc/music_sheets/guitar_strumming.php
* Version 
...
if(isset($_GET['strumming_id'])){
	$strumming_id = $_GET['strumming_id'];
	$strumming_id = output_html($strumming_id);
}
else {
	$strumming_id = "";
}
if($action == ""){
	...
	<!-- Where am I? -->
		...
		&gt;
		<a href=\"index.php?open=music_sheets&amp;page=guitar_strumming&amp;editor_language=$editor_language&amp;l=$l\">Guitar strumming</a>
		</p>
	<!-- //Where am I? -->

	<!-- Actions -->
		<p>
		<a href=\"index.php?open=music_sheets&amp;page=guitar_strumming&amp;action=new_strumming&amp;editor_language=$editor_language&amp;l=$l\" class=\"btn_default\">New strumming</a>
		<a href=\"index.php?open=music_sheets&amp;page=guitar_strumming&amp;action=new_finger_picking&amp;editor_language=$editor_language&amp;l=$l\" class=\"btn_default\">New finger picking</a>
		</p>
	<!-- //Actions -->
	...
	<!-- Select letter -->
		<div class=\"vertical\">
			<ul>
		";
		$query = "SELECT strumming_id, strumming_title, strumming_type, strumming_data, strumming_image_file, strumming_sound_file, strumming_video_short_file, strumming_video_short_embedded, strumming_video_tutorial_file, strumming_video_tutorial_embedded, strumming_unique_hits, strumming_unique_hits_ip_block, strumming_difficulty, strumming_created_datetime FROM $t_music_guitar_strumming_index ORDER BY strumming_title ASC";
		$result = mysqli_query($link, $query);
		while($row = mysqli_fetch_row($result)) {
			list($get_strumming_id, $get_strumming_title, $get_strumming_type, $get_strumming_data, $get_strumming_image_file, $get_strumming_sound_file, $get_strumming_video_short_file, $get_strumming_video_short_embedded, $get_strumming_video_tutorial_file, $get_strumming_video_tutorial_embedded, $get_strumming_unique_hits, $get_strumming_unique_hits_ip_block, $get_strumming_difficulty, $get_strumming_created_datetime) = $row;

			echo"<li>$get_strumming_title</li>\n";
		}	
		echo"
			</ul>
		</div>
