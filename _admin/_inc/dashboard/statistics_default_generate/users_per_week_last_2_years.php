...
var rootA = am5.Root.new(\"chartdiv_users_per_week_last_two_years\");
...
for($x=0;$x<12;$x++){
	...
	if($get_this_stats_registered_id != ""){
		if($inp_data_body == ""){
			$inp_data_body = "{
			  xlabelXYChart: \"$get_this_stats_registered_week\",
			  value1: $get_this_stats_registered_users_registed, 
			  value2: $get_last_stats_registered_users_registed
			}";
		}
		else{
			$inp_data_body = "{
...
$fp = fopen("../_cache/stats_default/users_per_week_last_2_years_$configSecurityCodeSav.js", "w") or die("Unable to open file!");
...
<html>
  <head>
    <meta charset=\"UTF-8\" />
    <title>users_per_week_last_2_years</title>
    <link rel=\"stylesheet\" href=\"index.css\" />
</head>
<body>
    <div id=\"chartdiv_users_per_week_last_two_years\" style=\"width: 100%;height: 80vh;\"></div>
...
<script src=\"users_per_week_last_2_years_$configSecurityCodeSav.js\"></script>
  </body>
</html>";

$fp = fopen("../_cache/stats_default/users_per_week_last_2_years_$configSecurityCodeSav.html", "w") or die("Unable to open file!");
fwrite($fp, $inp_test);
fclose($fp);
