...
/**
*
* File: _admin/_inc/_javascripts/statistics_year_generate/browsers_per_month.php
* Version 1
* Date 01:48 02.04.2022
...
$x = 0;
$query = "SELECT stats_browser_id, stats_browser_year, stats_browser_name, stats_browser_unique, stats_browser_hits FROM $t_stats_browsers_per_month WHERE stats_browser_month=$get_current_stats_visit_per_month_month AND stats_browser_year=$get_current_stats_visit_per_month_year AND stats_browser_language=$editor_language_mysql";
...
<html>
  <head>
    <meta charset=\"UTF-8\" />
    <title>browsers_per_month for $editor_language</title>
    <link rel=\"stylesheet\" href=\"index.css\" />
</head>
<body>
<h1>browsers_per_month for $editor_language</h1>
