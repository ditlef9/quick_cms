...
/**
*
* File: _admin/_inc/dashboard/statistics_year_generate/os_per_month.php
* Version 1
* Date 01:54 02.04.2022
...
$x = 0;
$query = "SELECT stats_os_id, stats_os_year, stats_os_name, stats_os_type, stats_os_unique, stats_os_hits FROM $t_stats_os_per_month WHERE stats_os_month=$get_current_stats_visit_per_month_month AND stats_os_year=$get_current_stats_visit_per_month_year AND stats_os_language=$editor_language_mysql";
...
<html>
  <head>
    <meta charset=\"UTF-8\" />
    <title>OS per year for $editor_language</title>
    <link rel=\"stylesheet\" href=\"index.css\" />
</head>
<body>
<h1>OS per year for $editor_language</h1>
