...
*/
	...
	if($get_stats_visit_per_year_id == ""){
		...
		(stats_visit_per_year_id, stats_visit_per_year_year, stats_visit_per_year_language, stats_visit_per_year_human_unique, stats_visit_per_year_human_unique_diff_from_last_year, stats_visit_per_year_human_average_duration, 
		stats_visit_per_year_human_new_visitor_unique, stats_visit_per_year_human_returning_visitor_unique, stats_visit_per_year_unique_desktop, stats_visit_per_year_unique_mobile, stats_visit_per_year_unique_bots, 
		...
		VALUES
		(NULL, $get_unprocessed_year, $inp_language_mysql, '0', '0', '0',
		'0', '0', '0', '0', '0',
