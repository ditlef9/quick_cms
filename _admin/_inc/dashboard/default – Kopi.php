		...
		<div class=\"dashboard_row_four\">
			<!-- 1.1 Visits per week -->
				<div class=\"dashboard_columns_four_wrapper\">
					...
					<!-- Javascript visits per week -->
						<div id=\"chartdiv_visits_per_week\" style=\"width: 100%;height: 300px;\"></div>";

						include("_inc/dashboard/statistics_default_generate/visits_per_week.php");
						echo"
						<script src=\"../_cache/default/stats_visits_per_week_$configSecurityCodeSav.js?rand=$rand\"></script>
