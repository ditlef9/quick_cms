...
/**
*
* File: _admin/_inc/dashboard/statistics_year_generate/browsers_per_year.php
* Version 1
* Date 00:50 02.04.2022
...
var root = am5.Root.new(\"chartdiv_browsers_per_year\");
...
$x = 0;
$query = "SELECT stats_browser_id, stats_browser_year, stats_browser_name, stats_browser_unique, stats_browser_hits FROM $t_stats_browsers_per_year WHERE stats_browser_year=$get_current_stats_visit_per_year_year AND stats_browser_language=$editor_language_mysql";
...
<html>
  <head>
    <meta charset=\"UTF-8\" />
    <title>Browsers_per_year for $editor_language</title>
    <link rel=\"stylesheet\" href=\"index.css\" />
</head>
<body>
<h1>Browsers_per_year for $editor_language</h1>

<div id=\"chartdiv_browsers_per_year\" style=\"width: 100%;height: 80vh;\"></div>
