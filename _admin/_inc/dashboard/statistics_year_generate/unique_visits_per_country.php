...
/**
*
* File: _admin/_inc/dashboard/statistics_year_generate/unique_visits_per_country.php
* Version 1
...
$x = 0;
$query = "SELECT stats_country_id, stats_country_name, stats_country_alpha_2, stats_country_unique, stats_country_hits FROM $t_stats_countries_per_year WHERE stats_country_year=$get_current_stats_visit_per_year_year AND stats_country_language=$editor_language_mysql";
...
<html>
  <head>
    <meta charset=\"UTF-8\" />
    <title>Unique visits per country for $editor_language</title>
    <link rel=\"stylesheet\" href=\"index.css\" />
</head>
<body>
<h1>Unique visits per country for $editor_language</h1>
