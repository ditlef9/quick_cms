...
/**
*
* File: _admin/_inc/dashboard/statistics_year.php
* Version 4.0
* Date 03:45 02.04.2022
...
if($get_current_stats_visit_per_year_id == ""){
	...
	<!-- Language -->
		...
		while($row = mysqli_fetch_row($result)) {
			...
			if($get_language_active_iso_two == "$editor_language"){
				echo"
				<li class=\"active\"><a href=\"index.php?open=dashboard&amp;page=statistics_year&amp;stats_year=$stats_year&amp;editor_language=$get_language_active_iso_two&amp;l=$l\"><img src=\"../$get_language_active_flag_path_32x32/$get_language_active_flag_active_32x32\" alt=\"$get_language_active_flag_active_32x32\" /><br />$get_language_active_name</a></li>\n";

			}
			else{
				echo"
				<li><a href=\"index.php?open=dashboard&amp;page=statistics_year&amp;stats_year=$stats_year&amp;editor_language=$get_language_active_iso_two&amp;l=$l\"><img src=\"../$get_language_active_flag_path_32x32/$get_language_active_flag_inactive_32x32\" alt=\"$get_language_active_flag_inactive_32x32\" /><br />$get_language_active_name</a></li>\n";
			}
		}
		echo"
			</ul>
	...
	<!-- Visits per month -->
		...
		";
		$cache_file = "visits_per_month_" . $stats_year . "_" . $editor_language . "_" . $configSecurityCodeSav . ".js";
		include("_inc/dashboard/statistics_year_generate/visits_per_month.php");
		echo"
		<script src=\"../_cache/stats_year/$cache_file?rand=$rand\"></script>
	<!-- //Visits per month -->

	<!-- Unique visits per Countries -->
		...
		";
		$cache_file = "visits_per_country_" . $stats_year . "_" . $editor_language . "_" . $configSecurityCodeSav . ".js";
		include("_inc/dashboard/statistics_year_generate/unique_visits_per_country.php");
		echo"
		<script src=\"../_cache/stats_year/$cache_file?rand=$rand\"></script>
		...
		<div class=\"flex_row\">
			<!-- Accepted languages -->
				<div class=\"flex_col_50\">
					...
					";
					$cache_file = "accepted_language_per_year_" . $stats_year . "_" . $editor_language . "_" . $configSecurityCodeSav . ".js";
					include("_inc/dashboard/statistics_year_generate/accepted_language_per_year.php");
					echo"
					<script src=\"../_cache/stats_year/$cache_file?rand=$rand\"></script>
			...
			<!-- Language used -->
				<div class=\"flex_col_50\">
					...
					";
					$cache_file = "languages_per_year_" . $stats_year . $configSecurityCodeSav . ".js";
					include("_inc/dashboard/statistics_year_generate/languages_per_year.php");
					echo"
					<script src=\"../_cache/stats_year/$cache_file?rand=$rand\"></script>
				</div>
			<!-- //Language used -->
		...
		<div class=\"flex_row\">
			...
			<!-- Os -->
				<div class=\"flex_col_50\">
					...
					";
					$cache_file = "os_per_year_" . $stats_year . "_" . $editor_language . "_" . $configSecurityCodeSav . ".js";
					include("_inc/dashboard/statistics_year_generate/os_per_year.php");
					echo"
					<script src=\"../_cache/stats_year/$cache_file?rand=$rand\"></script>
				</div>
			<!-- //Os -->
			...
			<!-- Mobile vs desktop -->
				<div class=\"flex_col_50\">
					...
					";
					$cache_file = "mobile_vs_desktop_per_year_" . "_" . $editor_language . "_" . $configSecurityCodeSav . ".js";
					include("_inc/dashboard/statistics_year_generate/mobile_vs_desktop_per_year.php");
					echo"
					<script src=\"../_cache/stats_year/$cache_file?rand=$rand\"></script>
				</div>
			<!-- //Mobile vs desktop -->
		...
		<div class=\"flex_row\">
			...
			<!-- Browsers -->
				<div class=\"flex_col_50\">
					...
					";
					$cache_file = "browsers_per_year_" . $stats_year . "_" . $editor_language . "_" . $configSecurityCodeSav . ".js";
					include("_inc/dashboard/statistics_year_generate/browsers_per_year.php");
					echo"
					<script src=\"../_cache/stats_year/$cache_file?rand=$rand\"></script>
				</div>
			<!-- //Browsers -->
			...
			<!-- Humans vs bots unique -->
				<div class=\"flex_col_50\">
					...
					";
					$cache_file = "humans_vs_bots_unique_per_year_" . $stats_year . "_" . $editor_language . "_" . $configSecurityCodeSav . ".js";
					include("_inc/dashboard/statistics_year_generate/humans_vs_bots_unique_per_year.php");
					echo"
					<script src=\"../_cache/stats_year/$cache_file?rand=$rand\"></script>
				</div>
			<!-- //Humans vs bots unique -->
	...
	<!-- Comments per month -->
		...
		<h2 style=\"margin-top: 20px;\">Comments per month <a href=\"#comments_per_month\" class=\"toggle\" data-divid=\"comments_per_month_information\"><img src=\"_inc/dashboard/_gfx/information_16x16.png\" alt=\"information.png\" /></a></h2>
		...
		";
		$cache_file = "comments_per_month_" . $stats_year . "_" . $editor_language . "_" . $configSecurityCodeSav . ".js";
		include("_inc/dashboard/statistics_year_generate/comments_per_month.php");
		echo"
		<script src=\"../_cache/stats_year/$cache_file?rand=$rand\"></script>
	...
	<!-- Bots -->
		...
		$query = "SELECT stats_bot_id, stats_bot_year, stats_bot_name, stats_bot_unique, stats_bot_hits FROM $t_stats_bots_per_year WHERE stats_bot_year=$get_current_stats_visit_per_year_year AND stats_bot_language=$editor_language_mysql ORDER BY stats_bot_unique DESC LIMIT 0,5";
		$result = mysqli_query($link, $query);
		while($row = mysqli_fetch_row($result)) {
	...
	<!-- Pages -->
		...
		<table class=\"hor-zebra\">
		 ...
		 <tbody>
		";
		$query = "SELECT stats_pages_per_year_id, stats_pages_per_year_url, stats_pages_per_year_title, stats_pages_per_year_title_fetched, stats_pages_per_year_human_unique, stats_pages_per_year_unique_desktop, stats_pages_per_year_unique_mobile, stats_pages_per_year_unique_bots FROM $t_stats_pages_visits_per_year WHERE stats_pages_per_year_year=$get_current_stats_visit_per_year_year AND stats_pages_per_year_language=$editor_language_mysql ORDER BY stats_pages_per_year_human_unique DESC LIMIT 0,50";
		$result = mysqli_query($link, $query);
		while($row = mysqli_fetch_row($result)) {
	...
	<!-- Referers-->
		...
		$query = "SELECT stats_referer_id, stats_referer_year, stats_referer_from_url, stats_referer_to_url, stats_referer_unique, stats_referer_hits FROM $t_stats_referers_per_year WHERE stats_referer_year=$get_current_stats_visit_per_year_year AND stats_referer_language=$editor_language_mysql ORDER BY stats_referer_unique DESC LIMIT 0,30";
		$result = mysqli_query($link, $query);
		while($row = mysqli_fetch_row($result)) {
