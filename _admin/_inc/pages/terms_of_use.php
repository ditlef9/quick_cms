...
// Get policy
$query = "SELECT terms_of_use_id, terms_of_use_title, terms_of_use_language, terms_of_use_text, terms_of_use_is_active, terms_of_use_created_date, terms_of_use_created_date_saying, terms_of_use_created_by_user_id, terms_of_use_created_by_user_name, terms_of_use_created_by_user_email, terms_of_use_created_by_name, terms_of_use_updated_date, terms_of_use_updated_date_saying, terms_of_use_updated_by_user_id, terms_of_use_updated_by_user_name, terms_of_use_updated_by_user_email, terms_of_use_updated_by_name FROM $t_pages_terms_of_use WHERE terms_of_use_language=$editor_language_mysql";
$result = mysqli_query($link, $query);
$row = mysqli_fetch_row($result);
list($get_current_terms_of_use_id, $get_current_terms_of_use_title, $get_current_terms_of_use_language, $get_current_terms_of_use_text, $get_current_terms_of_use_is_active, $get_current_terms_of_use_created_date, $get_current_terms_of_use_created_date_saying, $get_current_terms_of_use_created_by_user_id, $get_current_terms_of_use_created_by_user_name, $get_current_terms_of_use_created_by_user_email, $get_current_terms_of_use_created_by_name, $get_current_terms_of_use_updated_date, $get_current_terms_of_use_updated_date_saying, $get_current_terms_of_use_updated_by_user_id, $get_current_terms_of_use_updated_by_user_name, $get_current_terms_of_use_updated_by_user_email, $get_current_terms_of_use_updated_by_name) = $row;
if($get_current_terms_of_use_id == ""){
	...
	mysqli_query($link, "INSERT INTO $t_pages_terms_of_use(terms_of_use_id, terms_of_use_title, terms_of_use_language, terms_of_use_text, terms_of_use_is_active, terms_of_use_created_date, terms_of_use_created_date_saying, terms_of_use_created_by_user_id, terms_of_use_created_by_user_name, terms_of_use_created_by_user_email, terms_of_use_created_by_name)
					VALUES 
					(NULL, 'Terms of Use', $editor_language_mysql, '', '1', '$date', '$date_saying', $inp_my_user_id_mysql, $inp_my_user_name_mysql, $inp_my_user_email_mysql, $inp_my_name_mysql)
					") or die(mysqli_error());
...
if($process == "1"){
	...
	// Insert content
	$sql = "UPDATE $t_pages_terms_of_use SET terms_of_use_title=?, terms_of_use_text=?, terms_of_use_is_active=?, terms_of_use_updated_date=?, terms_of_use_updated_date_saying=?, terms_of_use_updated_by_user_id=?, terms_of_use_updated_by_user_name=?, terms_of_use_updated_by_user_email=?, terms_of_use_updated_by_name=? WHERE terms_of_use_id='$get_current_terms_of_use_id'";
...
<!-- Edit form -->
	...
	<form method=\"post\" action=\"index.php?open=$open&amp;page=$page&amp;editor_language=$editor_language&amp;process=1\" enctype=\"multipart/form-data\">
		...
		<p><b>Title</b><br />
		<input type=\"text\" name=\"inp_title\" value=\"$get_current_terms_of_use_title\" size=\"60\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\" />
		</p>

		<p><b>Is active</b><br />
		<input type=\"radio\" name=\"inp_is_active\" value=\"1\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\""; if($get_current_terms_of_use_is_active == "1"){ echo" checked=\"checked\""; } echo" /> Yes
		&nbsp;
		<input type=\"radio\" name=\"inp_is_active\" value=\"0\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\""; if($get_current_terms_of_use_is_active == "0"){ echo" checked=\"checked\""; } echo" /> No
		</p>

		<p>
		<textarea name=\"inp_text\" rows=\"40\" cols=\"120\" class=\"editor\">$get_current_terms_of_use_text</textarea>
		</p>
