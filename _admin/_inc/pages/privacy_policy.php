...
/**
*
* File: _admin/_inc/pages/privacy_policy.php
* Version 1.0 
...
// Get policy
$query = "SELECT privacy_policy_id, privacy_policy_title, privacy_policy_language, privacy_policy_text, privacy_policy_is_active, privacy_policy_created_date, privacy_policy_created_date_saying, privacy_policy_created_by_user_id, privacy_policy_created_by_user_name, privacy_policy_created_by_user_email, privacy_policy_created_by_name, privacy_policy_updated_date, privacy_policy_updated_date_saying, privacy_policy_updated_by_user_id, privacy_policy_updated_by_user_name, privacy_policy_updated_by_user_email, privacy_policy_updated_by_name FROM $t_pages_privacy_policy WHERE privacy_policy_language=$editor_language_mysql";
$result = mysqli_query($link, $query);
$row = mysqli_fetch_row($result);
list($get_current_privacy_policy_id, $get_current_privacy_policy_title, $get_current_privacy_policy_language, $get_current_privacy_policy_text, $get_current_privacy_policy_is_active, $get_current_privacy_policy_created_date, $get_current_privacy_policy_created_date_saying, $get_current_privacy_policy_created_by_user_id, $get_current_privacy_policy_created_by_user_name, $get_current_privacy_policy_created_by_user_email, $get_current_privacy_policy_created_by_name, $get_current_privacy_policy_updated_date, $get_current_privacy_policy_updated_date_saying, $get_current_privacy_policy_updated_by_user_id, $get_current_privacy_policy_updated_by_user_name, $get_current_privacy_policy_updated_by_user_email, $get_current_privacy_policy_updated_by_name) = $row;
if($get_current_privacy_policy_id == ""){
	...
	mysqli_query($link, "INSERT INTO $t_pages_privacy_policy(privacy_policy_id, privacy_policy_title, privacy_policy_language, privacy_policy_text, privacy_policy_is_active, privacy_policy_created_date, privacy_policy_created_date_saying, privacy_policy_created_by_user_id, privacy_policy_created_by_user_name, privacy_policy_created_by_user_email, privacy_policy_created_by_name)
					VALUES 
					(NULL, 'Privacy Policy', $editor_language_mysql, '', '1', '$date', '$date_saying', $inp_my_user_id_mysql, $inp_my_user_name_mysql, $inp_my_user_email_mysql, $inp_my_name_mysql)
					") or die(mysqli_error());
...
if($process == "1"){
	...
	// Insert content
	$sql = "UPDATE $t_pages_privacy_policy SET privacy_policy_title=?, privacy_policy_text=?, privacy_policy_is_active=?, privacy_policy_updated_date=?, privacy_policy_updated_date_saying=?, privacy_policy_updated_by_user_id=?, privacy_policy_updated_by_user_name=?, privacy_policy_updated_by_user_email=?, privacy_policy_updated_by_name=? WHERE privacy_policy_id='$get_current_privacy_policy_id'";
...
<!-- //Select language -->
	...
	<p>
	URL:<br />
	<a href=\"../legal/index.php?doc=privacy_policy&amp;l=$editor_language\">../legal/index.php?doc=privacy_policy&amp;l=$editor_language</a>
	</p>
...
<!-- Edit form -->
	...
	<form method=\"post\" action=\"index.php?open=$open&amp;page=$page&amp;editor_language=$editor_language&amp;process=1\" enctype=\"multipart/form-data\">
		...
		<p><b>Title</b><br />
		<input type=\"text\" name=\"inp_title\" value=\"$get_current_privacy_policy_title\" size=\"60\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\" />
		</p>

		<p><b>Is active</b><br />
		<input type=\"radio\" name=\"inp_is_active\" value=\"1\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\""; if($get_current_privacy_policy_is_active == "1"){ echo" checked=\"checked\""; } echo" /> Yes
		&nbsp;
		<input type=\"radio\" name=\"inp_is_active\" value=\"0\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\""; if($get_current_privacy_policy_is_active == "0"){ echo" checked=\"checked\""; } echo" /> No
		</p>

		<p>
		<textarea name=\"inp_text\" rows=\"40\" cols=\"120\" class=\"editor\">$get_current_privacy_policy_text</textarea>
		</p>
