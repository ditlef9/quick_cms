...
if($get_current_group_id == ""){
	...
	echo"
	<!-- Upload form -->
		<form method=\"POST\" action=\"index.php?open=$open&amp;page=open_group_upload_image&amp;group_id=$get_current_group_id&amp;editor_language=$editor_language&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
		<p>
