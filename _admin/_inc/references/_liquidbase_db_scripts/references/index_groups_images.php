...
/**
*
* File: _admin/_inc/courses/_liquibase/references/index_groups_images.php
* Version 1.0.0
...
$query = "SELECT * FROM $t_references_index_groups_images LIMIT 1";
$result = mysqli_query($link, $query);
if($result !== FALSE){
	// Count rows
	$row_cnt = mysqli_num_rows($result);
	echo"
	<p>$t_references_index_groups_images: $row_cnt</p>
	";
}
else{
	mysqli_query($link, "CREATE TABLE $t_references_index_groups_images(
