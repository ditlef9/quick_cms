...
/**
*
* File: _admin/_inc/references/open_group_upload_image.php
* Version 
...
if($get_current_group_id == ""){
	...
	if($process == "1"){
		...
		if(!(is_dir("../$get_current_reference_title_clean/$get_current_group_title_clean/_images/$get_current_group_title_clean"))){
			mkdir("../$get_current_reference_title_clean/$get_current_group_title_clean/_images/$get_current_group_title_clean");
		}

		// Upload image

		// Image folder
		$imageFolder = "../$get_current_reference_title_clean/$get_current_group_title_clean/_images/$get_current_group_title_clean/";
		...
		if (is_uploaded_file($temp['tmp_name'])){
			...
			$inp_file_path = "$get_current_reference_title_clean/$get_current_group_title_clean/_images/$get_current_group_title_clean";
			...
			mysqli_query($link, "INSERT INTO $t_references_index_groups_images
			(image_id, image_reference_id, image_group_id, image_title, image_text, 
			...
			VALUES 
			(NULL, $get_current_reference_id, $get_current_group_id, $inp_title_mysql, '', 
