...
$tables_array = array("$t_downloads_liquidbase", 
"$t_downloads_index", 
...
if($action == ""){
	...
	<a href=\"index.php?open=downloads&amp;page=menu&amp;editor_language=$editor_language&amp;l=$l\">Downloads</a>
	&gt;
	<a href=\"index.php?open=downloads&amp;page=backup&amp;editor_language=$editor_language&amp;l=$l\">Backup</a>
	</p>
	<!-- //Where am I? -->


	<p>
	<a href=\"index.php?open=downloads&amp;page=backup&amp;action=db_backup&amp;editor_language=$editor_language&amp;l=$l\" class=\"btn_default\">DB backup</a>
...
elseif($action == "db_backup"){
	...
	if($mode == ""){
		...
		<meta http-equiv=\"refresh\" content=\"2; url=index.php?open=downloads&amp;page=backup&amp;action=db_backup&amp;mode=header&amp;table_no=0&amp;backup_id=$backup_id&amp;editor_language=$editor_language&amp;l=$l\" />
		";
...
";
			...
			echo"
			<meta http-equiv=\"refresh\" content=\"0; url=index.php?open=downloads&amp;page=backup&amp;action=db_backup&amp;mode=header&amp;table_no=$next_table_no&amp;backup_id=$backup_id&amp;editor_language=$editor_language&amp;l=$l\" />
			";
			...
			echo"
			<meta http-equiv=\"refresh\" content=\"0; url=index.php?open=downloads&amp;page=backup&amp;action=db_backup&amp;mode=content&amp;table_no=0&amp;backup_id=$backup_id&amp;editor_language=$editor_language&amp;l=$l\" />
			";
		}
...
(";
			...
			$next_table_no = $table_no+1;
			echo"
			<meta http-equiv=\"refresh\" content=\"1; url=index.php?open=downloads&amp;page=backup&amp;action=db_backup&amp;mode=content&amp;table_no=$next_table_no&amp;backup_id=$backup_id&amp;editor_language=$editor_language&amp;l=$l\" />
			";
			...
			echo"Done!";
			echo"
			<meta http-equiv=\"refresh\" content=\"1; url=index.php?open=downloads&amp;page=backup&amp;action=db_backup&amp;mode=download&amp;backup_id=$backup_id&amp;ft=success&fm=backup_created&amp;editor_language=$editor_language&amp;l=$l\" />
			";
		}
	...
	elseif($mode == "download"){
		...
		<a href=\"index.php?open=downloads&amp;page=backup\" class=\"btn_default\">Home</a>
		</p>
		";
	}
} // export
