...
/**
*
* File: meal_plans/meal_plan_edit_text.php
* Version 1.0.0
* Date 10:50 15.04.2021
...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_current_meal_plan_id == ""){
		...
		if($process == 1){
			...
			$url = "meal_plan_edit_text.php?meal_plan_id=$get_current_meal_plan_id&l=$l";
		...
		<!-- Where am I ? -->
			...
			&gt;
			<a href=\"meal_plan_edit_text.php?meal_plan_id=$get_current_meal_plan_id&amp;l=$l\">$l_text</a>
			</p>
		<!-- //Where am I ? -->
		...
		<!-- Edit menu -->
			<div class=\"tabs\">
				<ul>
					...
					<li><a href=\"meal_plan_edit_text.php?meal_plan_id=$meal_plan_id&amp;l=$l\" class=\"selected\">$l_text</a></li>
		...
		<!-- Form -->
			...
			<form method=\"post\" action=\"meal_plan_edit_text.php?meal_plan_id=$get_current_meal_plan_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
