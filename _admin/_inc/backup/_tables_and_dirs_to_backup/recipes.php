...
/**
*
* File: _admin/_inc/backup/_tables_and_dirs_to_backup/recipes.php
...
$tables_backup_array = array(
			...
			"$t_recipes_main_ingredients",
			"$t_recipes_main_ingredients_translations", 
			...
			"$t_recipes_weekly_subscriptions", 
			"$t_recipes_weekly_subscriptions_checked_ingredients"
