...
if($get_current_form_id == ""){
	...
	if($process == "1"){
		...
		$sql = "UPDATE $t_contact_forms_index SET form_text_before_form=? WHERE form_id='$get_current_form_id'";
	...
	<!-- Where am I? -->
		...
		&gt;
		<a href=\"index.php?open=contact_forms&amp;page=$page&amp;form_id=$form_id&amp;editor_language=$editor_language\">Text before form</a>
		</p>
	<!-- //Where am I? -->
	...
	<!-- Form -->
		...
		<textarea name=\"inp_text\" rows=\"40\" cols=\"120\" class=\"editor\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\">$get_current_form_text_before_form</textarea>
		</p>
