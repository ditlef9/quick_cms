...
if(isset($_GET['stop'])){
	$stop = $_GET['stop'];
	$stop = output_html($stop);
}
else{
	$stop = 0;
}
if(!(is_numeric($stop))){
	echo"Stop must be numeric";
	die;
}
