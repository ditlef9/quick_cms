...
if(isset($_GET['workout_session_id'])){
	$workout_session_id = $_GET['workout_session_id'];
	$workout_session_id = output_html($workout_session_id);
}
else{
	$workout_session_id = "";
}
$workout_session_id_mysql = quote_smart($link, $workout_session_id);
