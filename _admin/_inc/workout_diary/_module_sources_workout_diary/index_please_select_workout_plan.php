...
/**
*
* File: workout_diary/index_please_select_workout_plan.php
* Version 1.0.0.
...
if($action == ""){
	echo"
	<h1>$l_almost_ready_to_change_your_life</h1>

	<h2>$l_select_a_workout_plan_from_the_list_below</h2>

	
	<p>
	<a href=\"$root/workout_plans/new_workout_plan.php?l=$l\" class=\"btn\">$l_create_a_custom_workout_plan</a>
	</p>
	...
	while($row_w = mysqli_fetch_row($result_w)) {
		...
		if($get_workout_weekly_image_file != ""){
			...
			echo"
					...
					<a href=\"index.php?action=select&amp;weekly_id=$get_workout_weekly_id&amp;l=$l&amp;process=1\" class=\"btn_default\">$l_choose</a>
					</p>
				</div>
			";
