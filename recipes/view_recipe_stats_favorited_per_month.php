...
/**
*
* File: recipes/view_recipe_stats_favorited_per_month.php
* Version 4.0
...
var rootA = am5.Root.new(\"chartdiv_favorited_per_month\");
...
$datetime_class->modify('-1 year'); // 1 year ago (we will start one year ago and go foward to today)
...
for($x=0;$x<12;$x++){
	...
	// Fetch this year
	$query = "SELECT stats_favorited_per_month_id, stats_favorited_per_month_month, stats_favorited_per_month_month_full, stats_favorited_per_month_month_short, stats_favorited_per_month_year, stats_favorited_per_month_recipe_id, stats_favorited_per_month_recipe_title, stats_favorited_per_month_recipe_image_path, stats_favorited_per_month_recipe_thumb_278x156, stats_favorited_per_month_recipe_language, stats_favorited_per_month_recipe_category_id, stats_favorited_per_month_recipe_category_translated, stats_favorited_per_month_count FROM $t_recipes_stats_favorited_per_month WHERE stats_favorited_per_month_recipe_id=$get_recipe_id AND stats_favorited_per_month_month=$month_n_lookup AND stats_favorited_per_month_year=$this_year_lookup";
	$result = mysqli_query($link, $query);
	$row = mysqli_fetch_row($result);
	list($get_this_stats_favorited_per_month_id, $get_this_stats_favorited_per_month_month, $get_this_stats_favorited_per_month_month_full, $get_this_stats_favorited_per_month_month_short, $get_this_stats_favorited_per_month_year, $get_this_stats_favorited_per_month_recipe_id, $get_this_stats_favorited_per_month_recipe_title, $get_this_stats_favorited_per_month_recipe_image_path, $get_this_stats_favorited_per_month_recipe_thumb_278x156, $get_this_stats_favorited_per_month_recipe_language, $get_this_stats_favorited_per_month_recipe_category_id, $get_this_stats_favorited_per_month_recipe_category_translated, $get_this_stats_favorited_per_month_count) = $row;
	if($get_this_stats_favorited_per_month_count == ""){
		$get_this_stats_favorited_per_month_count = 0;
	}


	// Fetch last year
	$query = "SELECT stats_favorited_per_month_id, stats_favorited_per_month_month, stats_favorited_per_month_month_full, stats_favorited_per_month_month_short, stats_favorited_per_month_year, stats_favorited_per_month_recipe_id, stats_favorited_per_month_recipe_title, stats_favorited_per_month_recipe_image_path, stats_favorited_per_month_recipe_thumb_278x156, stats_favorited_per_month_recipe_language, stats_favorited_per_month_recipe_category_id, stats_favorited_per_month_recipe_category_translated, stats_favorited_per_month_count FROM $t_recipes_stats_favorited_per_month WHERE stats_favorited_per_month_recipe_id=$get_recipe_id AND stats_favorited_per_month_month=$month_n_lookup AND stats_favorited_per_month_year=$last_year_lookup";
	$result = mysqli_query($link, $query);
	$row = mysqli_fetch_row($result);
	list($get_last_stats_favorited_per_month_id, $get_last_stats_favorited_per_month_month, $get_last_stats_favorited_per_month_month_full, $get_last_stats_favorited_per_month_month_short, $get_last_stats_favorited_per_month_year, $get_last_stats_favorited_per_month_recipe_id, $get_last_stats_favorited_per_month_recipe_title, $get_last_stats_favorited_per_month_recipe_image_path, $get_last_stats_favorited_per_month_recipe_thumb_278x156, $get_last_stats_favorited_per_month_recipe_language, $get_last_stats_favorited_per_month_recipe_category_id, $get_last_stats_favorited_per_month_recipe_category_translated, $get_last_stats_favorited_per_month_count) = $row;
	if($get_last_stats_favorited_per_month_count == ""){
		$get_last_stats_favorited_per_month_count = 0;
	}

	if($get_this_stats_favorited_per_month_month_short != ""){
		if($y > 0){
			$inp_data = $inp_data . ",";
		}
		$inp_data = $inp_data . "{
			  xlabelXYChart: \"$get_this_stats_favorited_per_month_month_short\",
			  value1: $get_this_stats_favorited_per_month_count,
			  value2: $get_last_stats_favorited_per_month_count
		}";
		$y++;
	}
...
<html>
  <head>
    <meta charset=\"UTF-8\" />
    <title>favorited_per_month</title>
