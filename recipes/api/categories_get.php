...
$query = "SELECT * FROM $t_recipes_categories JOIN $t_recipes_categories_translations ON $t_recipes_categories.category_id=$t_recipes_categories_translations.category_id WHERE $t_recipes_categories_translations.category_translation_language=$l_mysql";
