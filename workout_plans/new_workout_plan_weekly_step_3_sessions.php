...
/**
*
* File: food/new_workout_plan_weekly_step_3_sessions.php
* Version 1.0.0
* Date 15:48 01.02.2019
	...
	if($get_current_workout_weekly_id == ""){
		...
		if($action == ""){
			if($process == "1"){
				...
				// Header
				$url = "new_workout_plan_weekly_step_3_sessions.php?period_id=$period_id&l=$l";
				header("Location: $url");
				exit;
			...
			<!-- About sessions -->
				<p>
				$l_here_are_your_sessions
				$l_click_on_a_session_to_add_exercises_to_it
				</p>
			<!-- //About sessions -->
			...
			<!-- List all sessions -->
				...
				while($row = mysqli_fetch_row($result)) {
					...
					<tr>
					  <td class=\"$style\">
						<span><a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=open_session&amp;session_id=$get_workout_session_id&amp;l=$l\">$get_workout_session_title</a>
					  </td>
					  <td class=\"$style\">
						<span>";
						...
						if($x != 0){
							echo"
							<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=move_session_up&amp;session_id=$get_workout_session_id&amp;l=$l&amp;process=1\"><img src=\"_gfx/icons/go-up.png\" alt=\"go-up.png\" title=\"$l_move_up\" /></a>
							";
						}
						else{
							echo"
							...
							echo"
							<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=move_session_down&amp;session_id=$get_workout_session_id&amp;l=$l&amp;process=1\"><img src=\"_gfx/icons/go-down.png\" alt=\"go-down.png\" title=\"$l_move_down\" /></a>
							";


						echo"
						<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=edit_session&amp;session_id=$get_workout_session_id&amp;l=$l\"><img src=\"_gfx/icons/edit.png\" alt=\"edit.png\" title=\"$l_edit\" /></a>
						<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=delete_session&amp;session_id=$get_workout_session_id&amp;l=$l\"><img src=\"_gfx/icons/delete.png\" alt=\"delete.png\" title=\"$l_delete\" /></a>
						</span>
					 </td>
					</tr>
					";
					...
					if($x != $get_workout_session_weight){
						$res = mysqli_query($link, "UPDATE $t_workout_plans_sessions SET workout_session_weight='$x' WHERE workout_session_id='$get_workout_session_id'");

						//echo"
						//<div class=\"info\">
						//	<h1><img src=\"$root/_webdesign/images/loading_22.gif\" alt=\"loading_22.gif\" style=\"float:left;padding: 1px 5px 0px 0px;\" /> Loading...</h1>
						//</div>
						//<meta http-equiv=\"refresh\" content=\"1;url=new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;session_id=$get_workout_session_id&amp;l=$l\">
						//<span><a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=open_session&amp;session_id=$get_workout_session_id&amp;l=$l\">$get_workout_session_title</a>
						//";
			...
			<!-- Back -->
				<p>
				<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=new_session&amp;l=$l\" class=\"btn btn_default\">$l_new_session</a>
		...
		elseif($action == "new_session"){
			if($process == "1"){
				...
				$inp_duration = str_replace(",", ".", $inp_duration);		
				...
				// Now we need to get the correct weight
				// Select last workout plan weekly, and get the weight of that.
				$query_t = "SELECT workout_session_id, workout_session_weight FROM $t_workout_plans_sessions WHERE workout_session_user_id=$my_user_id_mysql AND workout_session_weekly_id='$get_current_workout_weekly_id' ORDER BY workout_session_weight DESC";
				$result_t = mysqli_query($link, $query_t);
				$row_t = mysqli_fetch_row($result_t);
				list($get_workout_session_id, $get_workout_session_weight) = $row_t;
				...
				VALUES 
				(NULL, $my_user_id_mysql, '$get_current_workout_weekly_id', $inp_workout_session_weight, $inp_title_mysql, $inp_title_clean_mysql, $inp_duration_mysql, $inp_intensity_mysql,
				$inp_warmup_mysql, $inp_end_mysql)
				")
				or die(mysqli_error($link));

				// Get ID
				$query_t = "SELECT workout_session_id FROM $t_workout_plans_sessions WHERE  workout_session_user_id=$my_user_id_mysql AND workout_session_weekly_id='$get_current_workout_weekly_id' AND workout_session_title=$inp_title_mysql";
				$result_t = mysqli_query($link, $query_t);
				$row_t = mysqli_fetch_row($result_t);
				...
				// Header
				$url = "new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&l=$l&ft=success&fm=session_created";
				header("Location: $url");
				exit;
			...
			<!-- Form -->
				...
				<form method=\"post\" action=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=new_session&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
	

				<p><b>$l_session_title:</b><br />
				<input type=\"text\" name=\"inp_title\" size=\"23\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\" />
				</p>

				<p><b>$l_duration:</b><br />
				<input type=\"text\" name=\"inp_duration\" size=\"23\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\" />
				</p>

				<p><b>$l_intensity:</b><br />
				<input type=\"text\" name=\"inp_intensity\" size=\"23\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\" />
				</p>
			...
			<!-- Back -->
				<p>
				<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;l=$l\" class=\"btn btn_default\">$l_sessions</a>
				<a href=\"weekly_workout_plan_edit.php?weekly_id=$weekly_id&amp;l=$l\" class=\"btn btn_default\">$l_next</a>
				</p>
			<!-- //Back -->
			";
		...
		elseif($action == "move_session_down"){
			...
			while($row = mysqli_fetch_row($result)) {
				...
				if($get_workout_session_id == "$session_id"){

					// Move this number weight +1
					$inp_workout_session_weight=$get_workout_session_weight+2;
					$res = mysqli_query($link, "UPDATE $t_workout_plans_sessions SET workout_session_weight='$inp_workout_session_weight' WHERE workout_session_id='$get_workout_session_id'");

					// Move prev -1
					//$inp_workout_session_weight_prev=$get_workout_session_weight-1;
					//$res = mysqli_query($link, "UPDATE $t_workout_plans_sessions SET workout_session_weight='$inp_workout_session_weight_prev' WHERE workout_session_id='$prev_workout_session_id'");

					
				}

				// Ready next interation
				// Send prev
				$prev_workout_session_id = $get_workout_session_id;
				$x++;
			}

			// Header
			$url = "new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&l=$l";
			header("Location: $url");
			exit;
		} // move_session_down
		...
		elseif($action == "edit_session"){
			...
			if($get_current_workout_session_id == ""){
				...
				if($process == "1"){
					...
					// Header
					$url = "new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&l=$l&ft=success&fm=changes_saved";
					header("Location: $url");
					exit;
		...
		elseif($action == "delete_session"){
			...
			if($get_workout_session_id == ""){
				...
				if($process == "1"){
					...
					// Header
					$url = "new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&l=$l&ft=success&fm=deleted";
					header("Location: $url");
					exit;
				...
				<p>
				<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=delete_session&amp;session_id=$session_id&amp;process=1&amp;l=$l\" class=\"btn btn_warning\">$l_delete</a>
				</p>
		...
		elseif($action == "open_session"){
			...
			if($get_workout_session_id == ""){
				...
				<!-- List sessions_main -->
				<p>
				<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=add_exercise_to_session&amp;session_id=$session_id&amp;type_id=$type_id&amp;l=$l\" class=\"btn btn_default\">$l_add_exercise</a>
				</p>
				...
				while($row = mysqli_fetch_row($result)) {
					...
					<tr>
					  ...
					  <td class=\"$style\">
						...
						if($x != 0){
							echo"
							<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=move_session_main_up&amp;session_id=$get_workout_session_id&amp;session_main_id=$get_workout_session_main_id&amp;l=$l&amp;process=1\">$l_move_up</a>
							&middot;
							";
						}
						echo"
						<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=move_session_main_down&amp;session_id=$get_workout_session_id&amp;session_main_id=$get_workout_session_main_id&amp;l=$l&amp;process=1\">$l_move_down</a>
						&middot;
						";
						echo"
						<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=edit_session_main&amp;session_id=$get_workout_session_id&amp;session_main_id=$get_workout_session_main_id&amp;l=$l\">$l_edit</a>
						&middot;
						<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=delete_session_main&amp;session_id=$get_workout_session_id&amp;session_main_id=$get_workout_session_main_id&amp;l=$l\">$l_delete</a>
						</span>
					 </td>
					</tr>
					";
				...
				<!-- //List sessions_main -->
				<p>
				<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=add_exercise_to_session&amp;session_id=$session_id&amp;l=$l\" class=\"btn btn_default\">$l_add_exercise</a>
				</p>
			...
			if($get_workout_session_id == ""){
					...
					<!-- Browse for exercise: Select type -->
						...
						<div class=\"vertical\">
							...
							while($row_sub = mysqli_fetch_row($result_sub)) {
								...
								echo"								";
								echo"<li><a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=$action&amp;session_id=$session_id&amp;type_id=$get_type_id&amp;mode=step_2_muscle_group&amp;l=$l\">$get_type_translation_value</a></li>\n";
				...
				elseif($mode == "step_2_muscle_group"){
					...
					<!-- Where am I ? -->
						...
						echo"
						<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=add_exercise_to_session&amp;session_id=$session_id&amp;type_id=$type_id&amp;mode=step_2_muscle_group&amp;l=$l\">$get_type_translation_value</a>
						</p>
					<!-- //Where am I ? -->
					...
					<!-- Browse for exercise: Select muscle group -->
						...
						<div class=\"vertical\">
							...
							while($row = mysqli_fetch_row($result)) {
								...
								echo"								";
								echo"<li><a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=$action&amp;session_id=$session_id&amp;type_id=$type_id&amp;main_muscle_group_id=$get_main_muscle_group_id&amp;mode=step_3_exercises&amp;l=$l\">$get_main_muscle_group_translation_name</a></li>\n";
				...
				elseif($mode == "step_3_exercises"){
					...
					<!-- Where am I ? -->
						...
						<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=add_exercise_to_session&amp;session_id=$session_id&amp;type_id=$type_id&amp;mode=step_2_muscle_group&amp;l=$l\">$get_type_translation_value</a>
						&gt;
						<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=add_exercise_to_session&amp;session_id=$session_id&amp;type_id=$type_id&amp;main_muscle_group_id=13&amp;mode=step_3_exercises&amp;l=$l\">$get_main_muscle_group_translation_name</a>
						</p>
					<!-- //Where am I ? -->
					...
					<!-- Browse for exercise: Exercises -->
						...
						while($row = mysqli_fetch_row($result)) {
							...
							<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=add_exercise_to_session&amp;session_id=$session_id&amp;type_id=$get_exercise_type_id&amp;main_muscle_group_id=$get_exercise_muscle_group_id_main&amp;exercise_id=$get_exercise_id&amp;mode=step_4_data&amp;l=$l\" class=\"exercise_index_title\">$get_exercise_title</a><br />
							</p>
							";
				...
				elseif($mode == "step_4_data"){
					...
					if($process == 1){
						...
						// Find weight
						$query = "SELECT workout_session_main_id, workout_session_main_weight FROM $t_workout_plans_sessions_main WHERE workout_session_main_user_id=$my_user_id_mysql AND workout_session_main_session_id='$get_workout_session_id' ORDER BY workout_session_main_weight DESC";
						$result = mysqli_query($link, $query);
						$row = mysqli_fetch_row($result);
						list($get_workout_session_main_id, $get_workout_session_main_weight) = $row;
						$inp_workout_session_main_weight = $get_workout_session_main_weight + 1;
						//echo"$get_workout_session_main_id, $get_workout_session_main_weight";die;
						...
						VALUES 
						(NULL, $my_user_id_mysql, '$get_workout_session_id', $inp_workout_session_main_weight, $inp_exercise_id_mysql, $inp_exercise_title_mysql, 
						...
						// Header
						$url = "new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&action=$action&session_id=$session_id&l=$l&type_id=$type_id&main_muscle_group_id=$main_muscle_group_id&mode=step_3_exercises&l=$l&ft=success&fm=added";
						header("Location: $url");
						exit;
					}
					...
					<!-- Form -->
						...
						<form method=\"post\" action=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=$action&amp;session_id=$session_id&amp;l=$l&amp;type_id=$type_id&amp;main_muscle_group_id=$main_muscle_group_id&amp;mode=step_4_data&amp;process=1\" enctype=\"multipart/form-data\">
						...
						<option value=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=$action&amp;session_id=$session_id&amp;l=$l\">- $l_type -</option>\n";
						// Get all types
						$query_sub = "SELECT type_id, type_title FROM $t_exercise_types ORDER BY type_title ASC";
						$result_sub = mysqli_query($link, $query_sub);
						while($row_sub = mysqli_fetch_row($result_sub)) {
							...
							echo"		";
							echo"<option value=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=$action&amp;session_id=$session_id&amp;type_id=$get_type_id&amp;mode=step_2_muscle_group&amp;l=$l\""; if($type_id == "$get_type_id"){ echo" selected=\"selected\"";}echo">$get_type_translation_value</option>\n";
						...
						while($row = mysqli_fetch_row($result)) {
							...
							if($main_muscle_group_id == ""){
								$main_muscle_group_id = "$get_main_muscle_group_id";
								$main_muscle_group_id_mysql = quote_smart($link, $main_muscle_group_id);
							}

							echo"		";
							echo"<option value=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=$action&amp;session_id=$session_id&amp;l=$l&amp;type_id=$type_id&amp;main_muscle_group_id=$get_main_muscle_group_id&amp;mode=step_3_exercises&amp;l=$l\""; if($get_main_muscle_group_id == "$main_muscle_group_id"){ echo" selected=\"selected\""; } echo">$get_main_muscle_group_translation_name</option>\n";
						}
						echo"
						</select>
					...
					<!-- Back -->
						<p style=\"margin-top: 40px;\">	
					<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=open_session&amp;session_id=$session_id&amp;type_id=$type_id&amp;l=$l\" class=\"btn btn_default\">$get_current_workout_session_title</a>
					<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;type_id=$type_id&amp;l=$l\" class=\"btn btn_default\">$l_sessions</a>
		...
		elseif($action == "edit_session_main"){
			...
			if($get_workout_session_id == ""){
				...
				$query = "SELECT workout_session_main_id, workout_session_main_user_id, workout_session_main_session_id, workout_session_main_weight, workout_session_main_exercise_id, workout_session_main_exercise_title, workout_session_main_reps, workout_session_main_sets, workout_session_main_velocity_a, workout_session_main_velocity_b, workout_session_main_distance, workout_session_main_duration, workout_session_main_intensity, workout_session_main_text
					  FROM $t_workout_plans_sessions_main WHERE workout_session_main_id=$session_main_id_mysql AND workout_session_main_user_id=$my_user_id_mysql";
				$result = mysqli_query($link, $query);
				$row = mysqli_fetch_row($result);
				...
				if($get_workout_session_main_id == ""){
					...
					if($process == 1){
						...
						$result = mysqli_query($link, "UPDATE $t_workout_plans_sessions_main SET 
								...
								WHERE
								 workout_session_main_id=$session_main_id_mysql AND workout_session_main_user_id=$my_user_id_mysql");

				
						// Header
						$url = "new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&action=open_session&session_id=$session_id&l=$l&type_id=$type_id&ft=success&fm=changes_saved";
						header("Location: $url");
						exit;
					}
					...
					<form method=\"post\" action=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=$action&amp;session_id=$session_id&amp;session_main_id=$session_main_id&amp;l=$l&amp;type_id=$type_id&amp;process=1\" enctype=\"multipart/form-data\">
					...
					<select name=\"inp_type_select\" id=\"inp_type_select\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\">
						...
						while($row_sub = mysqli_fetch_row($result_sub)) {
							...
							echo"		";
							echo"<option value=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=$action&amp;session_id=$session_id&amp;session_main_id=$session_main_id&amp;l=$l&amp;type_id=$get_type_id\""; if($type_id == "$get_type_id"){ echo" selected=\"selected\"";}echo">$get_type_translation_value</option>\n";
					...
					<select name=\"inp_exercise_id\" tabindex=\"";$tabindex=$tabindex+1;echo"$tabindex\">\n";
						...
						while($row = mysqli_fetch_row($result)) {
							...
							while($row_exercises = mysqli_fetch_row($result_exercises)) {
								...
								echo"		";
								echo"<option value=\"$get_exercise_id\""; if($get_current_workout_session_main_exercise_id == "$get_exercise_id"){ echo" selected=\"selected\"";}echo">$get_exercise_title</option>\n";
							}
							echo"		";
			...
			if($get_workout_session_id == ""){
				...
				if($get_workout_session_main_id == ""){
					...
					if($process == 1){
						...
						// Header
						$url = "new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&action=open_session&session_id=$session_id&l=$l&type_id=$type_id&ft=success&fm=deleted";
						header("Location: $url");
						exit;
					}
					...
					<!-- Where am I ? -->
						...
						<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=open_session&amp;session_id=$session_id&amp;type_id=$type_id&amp;l=$l\">$get_current_workout_session_title</a>
						&gt;
						<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=delete_session_main&amp;session_id=$session_id&amp;session_main_id=$session_main_id&amp;type_id=$type_id&amp;l=$l\">$l_delete</a>
						</p>
					<!-- //Where am I ? -->
					...
					<p>
					<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=delete_session_main&amp;session_id=$session_id&amp;session_main_id=$session_main_id&amp;type_id=$type_id&amp;l=$l&amp;process=1\" class=\"btn btn_warning\">$l_delete</a>
					<a href=\"new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&amp;action=open_session&amp;session_id=$session_id&amp;type_id=$type_id&amp;l=$l\" class=\"btn btn_default\">$l_cancel</a>
					</p>
		...
		elseif($action == "move_session_main_up"){
			...
			if($get_workout_session_id == ""){
				...
				if($get_workout_session_main_id == ""){
					...
					$inp_weight = $get_current_workout_session_main_weight-2;

					// Update
					$result = mysqli_query($link, "UPDATE $t_workout_plans_sessions_main SET workout_session_main_weight='$inp_weight'
								WHERE workout_session_main_id=$session_main_id_mysql AND workout_session_main_user_id=$my_user_id_mysql");

					// Header
					$url = "new_workout_plan_weekly_step_3_sessions.php?weekly_id=$weekly_id&action=open_session&session_id=$session_id&l=$l&type_id=$type_id";
					header("Location: $url");
					exit;
