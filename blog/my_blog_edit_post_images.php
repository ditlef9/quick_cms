...
/**
*
* File: blog/my_blog_edit_post_images.php
* Version 1.0.0
					...
					if($_SERVER["REQUEST_METHOD"] == "POST") {
						...
						if($image){
							...
							if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") && ($extension != "gif") && ($extension != "heic") && ($extension != "webp")) {
								...
								$url = "my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&l=$l&ft=$ft&fm=$fm"; 
								header("Location: $url");
								exit;
							}
							else{
...
";
				...
				<!-- Where am I? -->
					...
					&gt;
					<a href=\"my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&amp;l=$l\">$l_images</a>
					</p>
				<!-- //Where am I? -->
				...
				<!-- Upload image form -->
					...
					<form method=\"post\" action=\"my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
						...
						<table style=\"width: 100%;\">
						 <tr>
						  ...
						  <td style=\"vertical-align: top;\">
							...
							<p>
							<a href=\"my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&amp;action=edit_image&amp;image_id=$get_image_id&amp;l=$l\">$l_edit</a>
							&middot;
							<a href=\"my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&amp;action=rotate_image&amp;image_id=$get_image_id&amp;l=$l&amp;process=1\">$l_rotate</a>
							&middot;
							<a href=\"my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&amp;action=delete_image&amp;image_id=$get_image_id&amp;l=$l\">$l_delete</a>
							</p>
						  </td>
						 </tr>
						</table>
			...
			elseif($action == "edit_image"){
				...
				if($get_image_id == ""){
					...
					if($process == "1"){
						...
						$url = "my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&action=$action&image_id=$image_id&l=$l&ft=success&fm=changes_saved"; 
						header("Location: $url");
						exit;
					}
					...
					<form method=\"post\" action=\"my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&amp;action=$action&amp;image_id=$image_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">
					...
					<p>
					<a href=\"my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&amp;l=$l#image_id$image_id\"><img src=\"_gfx/icons/go-previous.png\" alt=\"go-previous.png\" /></a>
					<a href=\"my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&amp;l=$l#image_id$image_id\">$l_previous</a>
					</p>
					";
				}// image found
			} // action == "" edit_image
			elseif($action == "delete_image"){
				...
				if($get_image_id == ""){
					...
					if($process == "1"){
						...
						$url = "my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&l=$l&ft=success&fm=image_deleted"; 
						header("Location: $url");
						exit;
					}
					...
					<p>
					<a href=\"my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&amp;action=delete_image&amp;image_id=$get_image_id&amp;l=$l&amp;process=1\" class=\"btn_danger\">$l_confirm_delete</a>
					</p>
			...
			elseif($action == "rotate_image"){
				...
				if($get_image_id == ""){
					...
					if($process == "1"){
						...
						// Move
						$url = "my_blog_edit_post_images.php?post_id=$get_current_blog_post_id&l=$l&ft=success&fm=image_rotated#image_id$get_image_id"; 
						header("Location: $url");
						exit;
					} // process
				}// image found
