...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_exercise_id == ""){
		...
		echo"
		<h1>$l_edit_muscles_that_are_beeing_trained</h1>
		...
		<!-- Where am I? -->
			...
			&gt;
			<a href=\"$root/exercises/edit_exercise_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_muscle_group_id=$main_muscle_group_id&amp;type_id=$type_id&amp;l=$l\">$l_muscles_that_are_beeing_trained</a>
			</p>
		<!-- //Where am I? -->
					...
					echo"
					  <tr>
					   <td style=\"padding-left: 8px;\">
						<span>
						<a href=\"edit_exercise_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_muscle_group_id=$main_muscle_group_id&amp;type_id=$type_id&amp;main_group_id=$main_group_id&amp;sub_group_id=$sub_group_id&amp;muscle_id=$get_exercise_muscle_muscle_id&amp;l=$l&amp;action=remove\">$get_muscle_translation_simple_name</a>
						</span>
					   </td>
					  </tr>
					";
				...
				while($row = mysqli_fetch_row($result)) {
					...
					echo"	
					 <thead>
					  <tr>
					   <th scope=\"col\">
						<a href=\"edit_exercise_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_muscle_group_id=$main_muscle_group_id&amp;type_id=$type_id&amp;l=$l&amp;main_group_id=$get_main_muscle_group_id&amp;l=$l\""; if($main_group_id == "$get_main_muscle_group_id"){ echo" style=\"font-weight: bold;\"";}echo">$get_main_muscle_group_translation_name</a>
					   </th>
					  </tr>
					 </thead>
					 <tbody>
						...
						while($row_sub = mysqli_fetch_row($result_sub)) {
							...
							if($sub_group_id == "$get_sub_muscle_group_id"){
								...
								while($row_m = mysqli_fetch_row($result_m)) {
									...
									echo"
									<a href=\"edit_exercise_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_muscle_group_id=$main_muscle_group_id&amp;type_id=$type_id&amp;main_group_id=$get_main_muscle_group_id&amp;sub_group_id=$get_sub_muscle_group_id&amp;muscle_id=$get_muscle_id&amp;l=$l&amp;action=add\">$get_muscle_translation_simple_name</a>
									";
								...
								while($row_p = mysqli_fetch_row($result_p)) {
									...
									while($row_m = mysqli_fetch_row($result_m)) {
										...
										echo"
										<a href=\"edit_exercise_muscles_that_are_beeing_trained.php?exercise_id=$exercise_id&amp;main_muscle_group_id=$main_muscle_group_id&amp;type_id=$type_id&amp;main_group_id=$get_main_muscle_group_id&amp;sub_group_id=$get_sub_muscle_group_id&amp;muscle_id=$get_muscle_id&amp;l=$l&amp;action=add\">";
