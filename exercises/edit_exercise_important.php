...
/**
*
* File: exercise/edit_exercise_important.php
* Version 1.0.0
...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_exercise_id == ""){
		...
		if($process == 1){
			...
			$url = "edit_exercise_important.php?exercise_id=$exercise_id&main_muscle_group_id=$main_muscle_group_id&type_id=$type_id&l=$l";
		...
		<!-- Where am I? -->
			...
			&gt;
			<a href=\"$root/exercises/edit_exercise_important.php?exercise_id=$exercise_id&amp;main_muscle_group_id=$main_muscle_group_id&amp;type_id=$type_id&amp;l=$l\">$l_important</a>
			</p>
		<!-- //Where am I? -->
		...
		<!-- Form -->
			...
			<form method=\"post\" action=\"edit_exercise_important.php?exercise_id=$exercise_id&amp;main_muscle_group_id=$main_muscle_group_id&amp;type_id=$type_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\">


			<p><img src=\"$root/_admin/_translations/site/$get_exercise_language/$get_exercise_language.png\" alt=\"$get_exercise_language\" style=\"float: left;padding:4px 4px 0px 0px;\" /> <b>$l_important:</b><br />
		...
		<!-- Actions -->
			<div style=\"float:left;\">
				<p>
				<a href=\"edit_exercise_guide.php?exercise_id=$exercise_id&amp;main_muscle_group_id=$get_exercise_muscle_group_id_main&amp;type_id=$get_exercise_type_id&amp;l=$l\" class=\"small\">&lt; $l_guide</a>
				</p>
			</div>
			<div style=\"float:right;\">
				<p>
				<a href=\"edit_exercise_equipment.php?exercise_id=$exercise_id&amp;main_muscle_group_id=$get_exercise_muscle_group_id_main&amp;type_id=$get_exercise_type_id&amp;l=$l\" class=\"small\">$l_equipment &gt;</a>
				</p>
			</div>
		<!-- //Actions -->
		";
