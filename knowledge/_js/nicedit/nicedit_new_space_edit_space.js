...
var nicEditorPanel = bkClass.extend({
	construct : function(e,options,nicEditor) {
		...
		this.panelContain = new bkElement('DIV').setStyle({overflow : 'hidden', width : '100%', border : '1px solid #cccccc', backgroundColor : 'white'}).addClass('panelContain');
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
	nicURI : 'edit_space_general_image_uploader.php', // https://api.imgur.com/3/image
	...
	uploadFile : function() {
		...
		xhr.onload = function() {
			try {
				...
				return this.onError("Could not prase " + xhr.responseText);
			}
			if(data.error) {
