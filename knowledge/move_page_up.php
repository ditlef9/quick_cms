			...
			if($get_member_id == ""){
				...
				if($get_member_rank == "admin" OR $get_member_rank == "moderator" OR $get_member_rank == "editor"){
					...
					if($get_switch_page_id == ""){
						$url = "view_page.php?space_id=$get_current_page_space_id&page_id=$get_current_page_id&l=$l&ft=warning&fm=cant_move_position_because_switch_page_was_not_found";
						header("Location: $url");
						exit;
					}
					else{
