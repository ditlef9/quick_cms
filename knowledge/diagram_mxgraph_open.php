...
/**
*
* File: howto/diagram_editor_mxgraph_open.php 
* Version 1.0
		...
		if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
			...
			if($get_my_member_id == ""){
				...
				die;
					...
					// Set sessions
					$_SESSION['space_id'] 	= "$get_current_diagram_space_id";
					$_SESSION['page_id'] 	= "$get_current_diagram_page_id";
					$_SESSION['diagram_id'] = "$get_current_diagram_id"; 

					$url = "_js/mxgraph/javascript/examples/grapheditor/www/index.php?space_id=$get_current_space_id&page_id=$get_diagram_page_id&diagram_id=$get_diagram_id&l=$l";
					header("Location: $url");
					exit;
