...
if($get_current_space_id == ""){
	...
	if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
		...
		if($action == ""){
			...
			<!-- Edit space menu -->
				<p style=\"padding-bottom: 0;margin-bottom:0;\"><b>$l_edit_menu</b></p>
				<div class=\"vertical\">
					<ul>
						<li><a href=\"edit_space_general.php?space_id=$get_current_space_id&amp;l=$l\">$l_general</a></li>
						<li><a href=\"edit_space_members.php?space_id=$get_current_space_id&amp;l=$l\">$l_members</a></li>
					</ul>
				</div>
			<!-- Edit space menu -->
