...
if(isset($_GET['show_pcs'])) {
	$show_pcs = $_GET['show_pcs'];
	$show_pcs = strip_tags(stripslashes($show_pcs));
	if(!(is_numeric($show_pcs))){
		echo"Not numeric";
		die;
	}
}
...
list($get_current_main_category_id, $get_current_main_category_name, $get_current_main_category_icon_path, $get_current_main_category_icon_inactive_32x32, $get_current_main_category_icon_active_32x32, $get_current_main_category_icon_inactive_48x48, $get_current_main_category_icon_active_48x48, $get_current_main_category_age_limit) = $row;
	...
	// Title
	$website_title = "$get_current_sub_category_translation_value $l_nutritional_facts_lowercase EU - $get_current_main_category_translation_value - $get_current_title_value";
...
if($get_current_main_category_id == ""){
	...
	if($get_current_restriction_show_food == 1){
		echo"
		<!-- Headline -->
			<h1>$get_current_sub_category_translation_value $l_nutritional_facts_lowercase EU</h1>
		<!-- //Headline -->
		...
		<div class=\"two_rows\">
			<!-- Where am I ? -->
				<div class=\"two_columns\">
					...
					&gt;
					<a href=\"open_sub_category_nutritional_facts_eu.php?sub_category_id=$get_current_sub_category_id&amp;l=$l\">$l_nutritional_facts EU</a>
					</p>
				</div>
			<!-- //Where am I ? -->
	...
	<!-- Show table EU -->
		<p>
		<b>$l_show:</b>
		<input type=\"checkbox\" name=\"inp_show_hundred_metric\" class=\"onclick_go_to_url\""; if($show_hundred_metric == "1"){ echo" checked=\"checked\" data-target=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=0&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$order_by&amp;order_method=$order_method&amp;l=$l\""; } else{ echo" data-target=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=1&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$order_by&amp;order_method=$order_method&amp;l=$l\""; } echo" /> $l_hundred
		<input type=\"checkbox\" name=\"inp_show_pcs\" class=\"onclick_go_to_url\""; if($show_pcs == "1"){ echo" checked=\"checked\" data-target=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=0&amp;show_net_content=$show_net_content&amp;order_by=$order_by&amp;order_method=$order_method&amp;l=$l\""; } else{ echo" data-target=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=1&amp;show_net_content=$show_net_content&amp;order_by=$order_by&amp;order_method=$order_method&amp;l=$l\""; } echo" /> $l_pcs
		<input type=\"checkbox\" name=\"inp_show_net_content\" class=\"onclick_go_to_url\""; if($show_net_content == "1"){ echo" checked=\"checked\" data-target=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=0&amp;order_by=$order_by&amp;order_method=$order_method&amp;l=$l\""; } else{ echo" data-target=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=1&amp;order_by=$order_by&amp;order_method=$order_method&amp;l=$l\""; } echo" /> $l_net_content
		</p>
	...
	<!-- Food in subcategory -->
		  ...
		  <tr>
		   <th>
			<!-- Name -->";
				...
				echo"
				<span><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_name";
		   ...
		   <th>
			<!-- Place + score -->";
				$a_order_by = "score";
				echo"
				<span><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_place ($l_score)";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
				}
				elseif($order_by == "$a_order_by" && $order_method == "desc"){
		...
		if($show_hundred_metric == "1"){
			echo"
			   <th colspan=\"10\" style=\"text-align: center;\" class=\"category_main\">
				<span>$l_per 100</span>
			   </th>
			";
		}
		...
		if($show_hundred_metric == "1"){
			...
			<!-- Per 100 metric (2) -->
			   <th class=\"category_main_left\">";
				...
				echo"
				<span title=\"$l_calories\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_cal";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
				}
				elseif($order_by == "$a_order_by" && $order_method == "desc"){
			   ...
			   <th colspan=\"4\" class=\"category_sub\" style=\"text-align: center;\">";
				$a_order_by = "fat_metric";
				echo"
				<span title=\"$l_fat\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_fat</a></span>
			   </th>
			   <th colspan=\"2\" class=\"category_sub_right\" style=\"text-align: center;\">";
				$a_order_by = "carbohydrates_metric";
				echo"
				<span title=\"$l_carbohydrates\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_car</a></span>
			   </th>
			   <th class=\"category_main_middle\">";
				$a_order_by = "proteins_metric";
				echo"
				<span title=\"$l_proteins\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_pro";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
				}
				elseif($order_by == "$a_order_by" && $order_method == "desc"){
			   ...
			   <th class=\"category_main_middle\">";
				...
				echo"
				<span><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_salt";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
				}
				elseif($order_by == "$a_order_by" && $order_method == "desc"){
			   ...
			   <th class=\"category_main_right\">";
				...
				echo"
				<span title=\"$l_dietary_fiber\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_fib";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
				}
				elseif($order_by == "$a_order_by" && $order_method == "desc"){
		...
		if($show_pcs == "1"){
			...
			<!-- Per pcs metric (2)  -->
			   <th class=\"category_main_left\">";
				$a_order_by = "energy_calculated_metric";
				echo"
				<span title=\"$l_calories\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_cal";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
			   ...
			   <th colspan=\"4\" class=\"category_sub\" style=\"text-align: center;\">";
				$a_order_by = "fat_calculated_metric";
				echo"
				<span title=\"$l_fat\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_fat</a></span>
			   </th>
			   <th colspan=\"2\" class=\"category_sub_right\" style=\"text-align: center;\">";
			   ...
			   <th class=\"category_main_middle\">";
				$a_order_by = "proteins_calculated_metric";
				echo"
				<span title=\"$l_proteins\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_pro";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
			   ...
			   <th class=\"category_main_middle\">";
				$a_order_by = "salt_calculated_metric";
				echo"
				<span><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_salt";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
			   ...
			   <th class=\"category_main_right\">";
				$a_order_by = "dietary_fiber_calculated_metric";
				echo"
				<span title=\"$l_dietary_fiber\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_fib";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
		...
		if($show_hundred_metric == "1"){
			...
			<!-- Per 100 metric (3) -->
			   ...
			   <th class=\"category_sub_left\">
				...
				$a_order_by = "fat_metric";
				echo"
				<span><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_fat";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
				}
				elseif($order_by == "$a_order_by" && $order_method == "desc"){
			   ...
			   <th class=\"category_sub_middle\">
				...
				echo"
				<span title=\"$l_saturated_fat\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_sat";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
				}
				elseif($order_by == "$a_order_by" && $order_method == "desc"){
			   ...
			   <th class=\"category_sub_middle\">
				...
				echo"
				<span title=\"$l_monounsaturated_fat\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_mon";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
				}
				elseif($order_by == "$a_order_by" && $order_method == "desc"){
			   ...
			   <th class=\"category_sub_right\">
				...
				echo"
				<span title=\"$l_polyunsaturated_fat\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_pol";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
				}
				elseif($order_by == "$a_order_by" && $order_method == "desc"){
			   ...
			   <th class=\"category_sub_center\">
				...
				$a_order_by = "carbohydrates_metric";
				echo"
				<span title=\"$l_carbohydrates\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_car";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
				}
				elseif($order_by == "$a_order_by" && $order_method == "desc"){
			   ...
			   <th class=\"category_sub_right\">
				...
				echo"
				<span title=\"$l_sugar\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_sug";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
				}
				elseif($order_by == "$a_order_by" && $order_method == "desc"){
		...
		if($show_pcs == "1"){
			...
			<!-- Per pcs metric (3) -->
			   ...
			   <th class=\"category_sub_middle\">
				<!-- Fat 2-->";
				$a_order_by = "saturated_fat_calculated_metric";
				echo"
				<span title=\"$l_saturated_fat\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_sat";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
			   ...
			   <th class=\"category_sub_middle\">
				<!-- Fat 4-->";
				$a_order_by = "monounsaturated_fat_calculated_metric";
				echo"
				<span title=\"$l_monounsaturated_fat\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_mon";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
			   ...
			   <th class=\"category_sub_right\">
				<!-- Fat 5-->";
				$a_order_by = "polyunsaturated_fat_calculated_metric";
				echo"
				<span title=\"$l_polyunsaturated_fat\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_pol";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
			   ...
			   <th class=\"category_sub_center\">
				<!-- Car 1-->";
				$a_order_by = "carbohydrates_calculated_metric";
				echo"
				<span title=\"$l_carbohydrates\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_car";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
			   ...
			   <th class=\"category_sub_right\">
				<!-- Car 2-->";
				$a_order_by = "carbohydrates_of_which_sugars_calculated_metric";
				echo"
				<span title=\"$l_sugar\"><a href=\"open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$a_order_by&amp;order_method=$a_order_method&amp;l=$l\">$l_sug";
				if($order_by == "$a_order_by" && $order_method == "asc"){
					echo" <img src=\"_gfx/arrow_up.png\" alt=\"arrow_up.png\" />";
		...
		while($row = mysqli_fetch_row($result)) {
			...
			if($order_by == "score" && $order_method == "asc" && $get_food_score_place_in_sub_category != "$score_place_in_sub_category_counter"){
				...
				echo"<div class=\"info\"><p>Updated score place in sub category for $get_food_name..</div>
				<meta http-equiv=\"refresh\" content=\"1;url=open_sub_category_nutritional_facts_eu.php?main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_current_sub_category_id&amp;show_hundred_metric=$show_hundred_metric&amp;show_pcs=$show_pcs&amp;show_net_content=$show_net_content&amp;order_by=$order_by&amp;order_method=$order_method&amp;l=$l\">";
			} // Score
				...
				<!-- Name and image -->
					...
					if(file_exists("$root/$get_food_image_path/$get_food_image_a") && $get_food_image_a != ""){
						...
						if(file_exists("../$get_food_image_path/$get_food_thumb_a_small") && $get_food_thumb_a_small != ""){
							echo"
							<a href=\"view_food.php?main_category_id=$get_food_main_category_id&amp;sub_category_id=$get_food_sub_category_id&amp;food_id=$get_food_id&amp;l=$l\"><img src=\"$root/$get_food_image_path/$get_food_thumb_a_small\" alt=\"$get_food_image_a\" width=\"132\" height=\"132\" style=\"max-width: none;\" /></a>
							  </td>
							  <td>
							";
						}
					...
					echo"
						...
						$get_food_net_content_metric $get_food_net_content_measurement_metric<br /></span>
						
						<span>
						$get_food_serving_size_pcs $get_food_serving_size_pcs_measurement:
						$get_food_serving_size_metric $get_food_serving_size_measurement_metric</span>
					   </td>
					  </tr>
					 </table>
				<!-- //Name and image -->
			...
			if($show_pcs == "1"){
				...
				<!-- Per pcs us -->
				   ...
				   <td class=\"category_sub_center\">
					<!-- Fat 2 -->
					<span>$get_food_saturated_fat_calculated_metric</span>
					<!-- //Fat 2 -->
				   </td>
				   <td class=\"category_sub_center\">
					<!-- Fat 4 -->
					<span>$get_food_monounsaturated_fat_calculated_metric</span>
					<!-- //Fat 4 -->
				   </td>
				   <td class=\"category_sub_right\">
					<!-- Fat 5 -->
					<span>$get_food_polyunsaturated_fat_calculated_metric</span>
					<!-- //Fat 5 -->
				   </td>
				   <td class=\"category_sub_center\">
					<!-- Carbohydrates 1 -->
				   ...
				   <td class=\"category_sub_right\">
					<!-- Carbohydrates 2 -->
					<span>$get_food_carbohydrates_of_which_sugars_calculated_metric</span>
					<!-- //Carbohydrates 2 -->
				   </td>
				   <td class=\"category_main_center\">
					<!-- Proteins -->
				   ...
				   <td class=\"category_main_center\">
					<!-- Salt -->
					<span>$get_food_salt_calculated_metric</span>
					<!-- //Salt -->
				   </td>
				   <td class=\"category_main_right\">
					<!-- Fiber -->
					<span>$get_food_dietary_fiber_calculated_metric</span>
					<!-- //Fiber -->
				   </td>
				<!-- //Per pcs -->
				";
		...
		// Calculations : min (for both metric and us)
		...
		if($inp_current_sub_category_trans_fat_min_100_g == 999){
			...
			$inp_current_sub_category_trans_fat_min_us = 0;
		}
