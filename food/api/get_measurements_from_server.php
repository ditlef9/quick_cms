...
// Diet categories
$query = "SELECT * FROM $t_food_measurements JOIN $t_food_measurements_translations ON $t_food_measurements.measurement_id=$t_food_measurements_translations.measurement_id WHERE $t_food_measurements_translations.measurement_translation_language=$l_mysql";
