...
/**
*
* File: food/edit_food_numbers_eu_pcs_metric.php
* Version 2
* Date 13:45 08.04.2022
	...
	if(isset($_SESSION['user_id'])){
		...
		elseif($access == 1){
			if($process == 1){
				...
				$url = "edit_food_numbers_eu_pcs_metric.php?food_id=$get_current_food_id&l_$l&ft=success&fm=changes_saved";
				header("Location: $url");
				exit;
			...
			<!-- Where am I? -->
				...
				&gt;
				<a href=\"edit_food_numbers_eu_pcs_metric.php?food_id=$food_id&amp;l=$l\">$l_numbers</a>
				</p>
			<!-- //Where am I? -->
				...
				<div style=\"float: left;margin-right: 20px;\">
					...
					<!-- System-country + Measurement -->
						<div style=\"text-align: center;\">
							...
							<a href=\"edit_food_numbers_eu_hundred_metric.php?food_id=$food_id&amp;l=$l\">$l_per_hundred</a>
							&middot;
							<a href=\"edit_food_numbers_eu_pcs_metric.php?food_id=$food_id&amp;l=$l\" style=\"font-weight:bold;\">$get_current_food_serving_size_pcs $get_current_food_serving_size_pcs_measurement</a>
							</span>
						</div>
					<!-- //System-country + Measurement -->
					...
					<form method=\"post\" action=\"edit_food_numbers_eu_pcs_metric.php?food_id=$get_current_food_id&amp;l=$l&amp;process=1\" enctype=\"multipart/form-data\" id=\"edit_food_numbers_form\">
					 ...
					 <tbody>
					  ...
					  <tr>
					   ...
					   <td style=\"text-align: center;padding: 0px 4px 0px 4px;\">
						...
						<p style=\"margin:0;padding: 0;\"><input type=\"text\" name=\"inp_food_trans_fat_calculated\" value=\"$get_current_food_trans_fat_calculated_metric\" size=\"3\" /></p>
					  ...
					  <tr>
					   ...
					   <td style=\"text-align: center;padding: 0px 4px 0px 4px;\">
						...
						<span class=\"food_added_sugars\">$get_current_food_added_sugars_metric</span></p>
					   ...
					   <td style=\"text-align: center;padding: 0px 4px 0px 4px;\">
						...
						<p style=\"margin:0;padding: 0;\"><input type=\"text\" name=\"inp_food_added_sugars_calculated\" value=\"$get_current_food_added_sugars_calculated_metric\" size=\"3\" /></p>
					   </td>
					  </tr>
					  <tr>
		 			  <td style=\"padding: 8px 4px 6px 8px;\">
