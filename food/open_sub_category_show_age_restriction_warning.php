...
if($action == ""){
	...
	while($row = mysqli_fetch_row($result)) {
		...
		echo"
			<li><a href=\"open_sub_category.php?action=view_agreement&amp;main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;country=$get_restriction_country_iso_two&amp;l=$l\"><img src=\"$root/$get_restriction_country_flag_path_16x16/$get_restriction_country_flag_16x16\" alt=\"$get_restriction_country_flag_16x16\" /> $get_restriction_country_name</a></li>
		";
...
elseif($action == "view_agreement"){
	...
	list($get_restriction_id, $get_crestriction_country_name, $get_restriction_country_iso_two, $get_restriction_title, $get_restriction_text) = $row;
	...
	if($get_restriction_id == ""){
		...
		<p>
		<a href=\"open_sub_category.php?action=agree_to_agreement&amp;main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;country=$get_restriction_country_iso_two&amp;l=$l&amp;process=1\" class=\"btn_default\">$l_agree</a>
		</p>
		";
	}
} // view_agreement
elseif($action == "agree_to_agreement"){
	...
	if($get_current_restriction_id == ""){
		...
		$url = "open_sub_category.php?main_category_id=$main_category_id&sub_category_id=$sub_category_id&l=$l&ft=success&fm=agreement_stored";
		header("Location: $url");
		exit;
	}
}
