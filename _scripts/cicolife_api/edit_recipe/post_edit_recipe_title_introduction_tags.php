...
if($fm == ""){
	...
	// Update recipe
	mysqli_query($link, "UPDATE $t_recipes SET recipe_title=$inp_title_mysql, recipe_introduction=$inp_introduction_mysql, recipe_tags=$inp_tags_mysql WHERE recipe_id=$inp_recipe_id_mysql") or die(mysqli_error($link));
