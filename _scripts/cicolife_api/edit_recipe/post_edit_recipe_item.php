...
if($fm == ""){
	...
	// Update recipe
	mysqli_query($link, "UPDATE $t_recipes_items SET item_amount=$inp_amount_mysql, item_measurement=$inp_measurement_mysql, item_grocery=$inp_grocery_mysql, item_calories_per_hundred=$inp_calories_per_hundred_mysql, item_calories_calculated=$inp_calories_calculated_mysql WHERE item_id=$inp_item_id_mysql") or die(mysqli_error($link));
