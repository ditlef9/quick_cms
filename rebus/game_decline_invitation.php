...
/**
*
* File: rebus/game_decline_invitation.php
* Version 1.0.0.
...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	// Decline invitation
	mysqli_query($link, "DELETE FROM $t_rebus_games_invited_players WHERE invited_player_id=$get_current_invited_player_id") or die(mysqli_error($link));

	// Welcome
	$url = "index.php?game_id=$get_current_game_id&l=$l&ft=success&fm=declined";
	header("Location: $url");
	exit;
