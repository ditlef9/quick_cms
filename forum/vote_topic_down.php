...
/**
*
* File: forum/vote_topic_down.php
* Version 1.0.0
...
if($get_current_topic_id == ""){
	...
	if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
		...
		// Ready input
		$inp_topic_likes_ip_block = $get_my_user_id . ":0";
