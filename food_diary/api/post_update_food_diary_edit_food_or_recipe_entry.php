...
mysqli_query($link, "UPDATE $t_food_diary_entires SET 
...
entry_carb_per_entry=$inp_entry_carb_per_entry_mysql, 
entry_protein_per_entry=$inp_entry_protein_per_entry_mysql,
entry_updated='$datetime'
WHERE entry_id=$inp_entry_id_mysql AND entry_user_id='$get_user_id'")
