...
if(isset($_SESSION['user_id']) && isset($_SESSION['security'])){
	...
	if($get_current_meal_plan_id == ""){
		...
		if($action == ""){
			...
			<!-- You are here -->
				<p>$l_you_are_here:<br />
				<a href=\"new_meal_plan_step_2_entries.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;l=$l\">$l_meal_plan</a>
				&gt;
				<a href=\"new_meal_plan_step_2_entries_new_entry_food.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;l=$l\">$l_add_food</a>
				</p>
			<!-- //You are here -->
			...
			<!-- Meal plans Food search -->
				<!-- Search engines Autocomplete -->
							...
							\$('#inp_entry_food_query').keyup(function () {
        							...
        							if(searchString) {
        								// ajax call
          								\$.ajax({
                								type: \"POST\",
               									url: \"new_meal_plan_step_2_entries_new_entry_food_query.php\",
                								data: data,
					...
					echo"
					<form method=\"get\" action=\"new_meal_plan_step_2_entries_new_entry_food.php\" enctype=\"multipart/form-data\" id=\"inp_entry_food_query_form\">
						<p><b>$l_food</b><br />
				...
				<div class=\"vertical\">
					...
					while($row = mysqli_fetch_row($result)) {
						...
						list($get_category_translation_value) = $row_t;
							...
							echo"		";
							echo"<li><a href=\"new_meal_plan_step_2_entries_new_entry_food.php?action=open_main_food_category&amp;meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;main_category_id=$get_category_id&amp;l=$l\""; if($main_category_id == "$get_category_id"){ echo" style=\"font-weight: bold;\"";}echo">$get_category_translation_value</a></li>\n";
		...
		elseif($action == "open_main_food_category"){
			...
			if($get_current_main_category_id == ""){
				...
				<!-- You are here -->
					...
					<a href=\"new_meal_plan_step_2_entries_new_entry_food.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;l=$l\">$l_add_food</a>
					&gt;
					<a href=\"new_meal_plan_step_2_entries_new_entry_food.php?action=open_main_food_category&amp;meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;main_category_id=$main_category_id&amp;l=$l\">$get_current_main_category_translation_value</a>
					</p>
				<!-- //You are here -->
				...
				<!-- Meal plans Food sub categories -->
					<div class=\"vertical\">
						...
						while($rowb = mysqli_fetch_row($resultb)) {
							...
							echo"		";
							echo"<li><a href=\"new_meal_plan_step_2_entries_new_entry_food.php?action=open_sub_food_category&amp;meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;main_category_id=$get_current_main_category_id&amp;sub_category_id=$get_sub_category_id&amp;l=$l\">$get_sub_category_translation_value</a></li>\n";
			...
			if($get_current_main_category_id == ""){
				...
				if($get_current_sub_category_id== ""){
					...
					<!-- You are here -->
						...
						<a href=\"new_meal_plan_step_2_entries_new_entry_food.php?action=open_main_food_category&amp;meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;main_category_id=$main_category_id&amp;l=$l\">$get_current_main_category_translation_value</a>
						&gt;
						<a href=\"new_meal_plan_step_2_entries_new_entry_food.php?action=open_sub_food_category&amp;meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;main_category_id=$main_category_id&amp;sub_category_id=$sub_category_id&amp;l=$l\">$get_current_sub_category_translation_value</a>
						</p>
					<!-- //You are here -->
					...
					<!-- //Meal plans :: Food list -->
					";
				} // sub_food_category_found
			} // main food category found
		} // open_sub_food_category
		elseif($action == "search"){
			...
			<!-- You are here -->
				...
				<a href=\"new_meal_plan_step_2_entries_new_entry_food.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;l=$l\">$l_add_food</a>
				&gt;
				<a href=\"new_meal_plan_step_2_entries_new_entry_food.php?action=search&amp;meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;l=$l&amp;inp_entry_food_query=$inp_entry_food_query\">$l_search</a>
				</p>
			<!-- //You are here -->
		...
		elseif($action == "do_add_food"){
			if($process == 1){
				...
				if($inp_entry_food_serving_size == ""){
					$url = "new_meal_plan_step_2_entries.php?meal_plan_id=$meal_plan_id&entry_day_number=$entry_day_number&entry_meal_number=$entry_meal_number&l=$l&action=new_entry_food";
