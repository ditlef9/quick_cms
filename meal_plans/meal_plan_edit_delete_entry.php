	...
	if($get_current_meal_plan_id == ""){
		...
		if($get_current_entry_id == ""){
			...
			<!-- Delete form -->
				...
				<p>
				<a href=\"meal_plan_edit_delete_entry.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$entry_meal_number&amp;l=$l&amp;action=delete_entry&amp;entry_id=$entry_id&amp;process=1\" class=\"btn btn_warning\">$l_confirm</a>
				</p>
			<!-- //Delete form -->
			";
		} // entry found
