				 ...
				 <tbody>
				  <tr>
				   <td style=\"paddding: 0px 0px 0px 0px;margin: 0px 0px 0px 0px;\">
					...
					<a href=\"new_meal_plan_step_2_entries.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=1&amp;l=$l&amp;\""; if($entry_day_number == "1"){ echo" style=\"font-weight: bold;\""; } echo">$l_monday</a><br />
					<a href=\"new_meal_plan_step_2_entries.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=2&amp;l=$l&amp;\""; if($entry_day_number == "2"){ echo" style=\"font-weight: bold;\""; } echo">$l_tuesday</a><br />
					<a href=\"new_meal_plan_step_2_entries.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=3&amp;l=$l&amp;\""; if($entry_day_number == "3"){ echo" style=\"font-weight: bold;\""; } echo">$l_wednesday</a><br />
					<a href=\"new_meal_plan_step_2_entries.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=4&amp;l=$l&amp;\""; if($entry_day_number == "4"){ echo" style=\"font-weight: bold;\""; } echo">$l_thursday</a><br />
					<a href=\"new_meal_plan_step_2_entries.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=5&amp;l=$l&amp;\""; if($entry_day_number == "5"){ echo" style=\"font-weight: bold;\""; } echo">$l_friday</a><br />
					<a href=\"new_meal_plan_step_2_entries.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=6&amp;l=$l&amp;\""; if($entry_day_number == "6"){ echo" style=\"font-weight: bold;\""; } echo">$l_saturday</a><br />
					<a href=\"new_meal_plan_step_2_entries.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=7&amp;l=$l&amp;\""; if($entry_day_number == "7"){ echo" style=\"font-weight: bold;\""; } echo">$l_sunday</a><br />
					</p>
				   </td>
				  </tr>
				 </tbody>
					  ...
					  <tr>
					   <th scope=\"col\">
						...
						<div style=\"float: right;\">
							<span>
							<a href=\"new_meal_plan_step_2_entries_new_entry_food.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$x&amp;l=$l\"><img src=\"_gfx/icons/add.png\" alt=\"add.png\" /></a>
							<a href=\"new_meal_plan_step_2_entries_new_entry_food.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$x&amp;l=$l\">$l_add_food</a>
							&nbsp;
							<a href=\"new_meal_plan_step_2_entries_new_entry_recipe.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$x&amp;l=$l\"><img src=\"_gfx/icons/add.png\" alt=\"add.png\" /></a>
							<a href=\"new_meal_plan_step_2_entries_new_entry_recipe.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$x&amp;l=$l\">$l_add_recipe</a>
							</span>
						</div>
					   </th>
					  </tr>
								 ...
								 <tr>
								  ...
								  <td style=\"width: 26%;\">";
									if($get_entry_food_id != "0"){
										echo"
										<span><a href=\"$root/food/view_food.php?view_food.php?main_category_id=$get_entry_main_category_id&amp;sub_category_id=$get_entry_sub_category_id&amp;food_id=$get_entry_food_id&amp;l=$l\">$get_entry_food_manufacturer_name $get_entry_food_name</a></span>
										";
									}
									else{
										echo"
										<span><a href=\"$root/recipes/view_recipe.php?recipe_id=$get_entry_recipe_id&amp;l=$l\">$get_entry_food_name</a></span>
										";
									}
									echo"
								  </td>
								  ...
								  <td style=\"width: 10%;text-align: right;\">
									<span>
									<a href=\"new_meal_plan_step_2_entries_move_entry_up.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$x&amp;l=$l&amp;entry_id=$get_entry_id&amp;process=1\"><img src=\"_gfx/icons/go-up.png\" alt=\"go-up.png\" title=\"Move up\" /></a>
									<a href=\"new_meal_plan_step_2_entries_move_entry_down.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$x&amp;l=$l&amp;entry_id=$get_entry_id&amp;process=1\"><img src=\"_gfx/icons/go-down.png\" alt=\"go-down.png\" title=\"Move down\" /></a>
									<a href=\"new_meal_plan_step_2_entries_edit_entry.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$x&amp;l=$l&amp;entry_id=$get_entry_id\"><img src=\"_gfx/icons/edit.png\" alt=\"edit.png\" title=\"$l_edit\" /></a>
									<a href=\"new_meal_plan_step_2_entries_delete_entry.php?meal_plan_id=$meal_plan_id&amp;entry_day_number=$entry_day_number&amp;entry_meal_number=$x&amp;l=$l&amp;entry_id=$get_entry_id\"><img src=\"_gfx/icons/delete.png\" alt=\"delete.png\" title=\"$l_delete\" /></a>
									</span>
								  </td>
								 </tr>
								</table>
